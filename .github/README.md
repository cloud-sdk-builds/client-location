...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.199.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.199.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2x55sbGjpp8EIDD/hP7qTQHzFc5WR+uF8xJv5UIm4kTvboEhpQ/9bHwvkV4uaQNn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.199.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.199.0/index.min.mjs": "sha384-2x55sbGjpp8EIDD/hP7qTQHzFc5WR+uF8xJv5UIm4kTvboEhpQ/9bHwvkV4uaQNn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.199.0/LICENSE
```

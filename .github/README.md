...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6MUa61Ro5p5oDHGr0Zrn1yiVcQt33itbv7iqqSULk+DU/tJt7AOfB1PGuGB4mXPf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.281.0/index.min.mjs": "sha384-6MUa61Ro5p5oDHGr0Zrn1yiVcQt33itbv7iqqSULk+DU/tJt7AOfB1PGuGB4mXPf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.281.0/LICENSE
```

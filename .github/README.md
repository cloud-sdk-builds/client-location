...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.130.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.130.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7eFwhQCjj/mXHh3GReewHRv1a1WX9XqqQ7ta+mcMV4txC3IdZ1cYLjylly2U/8Zi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.130.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.130.0/index.min.mjs": "sha384-7eFwhQCjj/mXHh3GReewHRv1a1WX9XqqQ7ta+mcMV4txC3IdZ1cYLjylly2U/8Zi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.130.0/LICENSE
```

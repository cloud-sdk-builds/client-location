...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.590.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.590.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BPCKBlunpnq6hX8KWqyUpsato3+lE4IK6K1ObFhnzWziUd53+4nxL5AHh0UyilGg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.590.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.590.0/index.min.mjs": "sha384-BPCKBlunpnq6hX8KWqyUpsato3+lE4IK6K1ObFhnzWziUd53+4nxL5AHh0UyilGg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.590.0/LICENSE
```

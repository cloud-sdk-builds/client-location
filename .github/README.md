...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.161.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.161.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xQEjHbelR+H5GCqm7XgP1zkq35ND3+vsT106HOjHLcstZKH5aCgXjSBSjvqRnP/p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.161.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.161.0/index.min.mjs": "sha384-xQEjHbelR+H5GCqm7XgP1zkq35ND3+vsT106HOjHLcstZKH5aCgXjSBSjvqRnP/p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.161.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.23.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.23.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-znV4M300mnAgRmXwwM5vuW91OMz+80sSPIpqlm4/xxhz6K+xGOFs6ormF1aapDFt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.23.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.23.0/index.min.mjs": "sha384-znV4M300mnAgRmXwwM5vuW91OMz+80sSPIpqlm4/xxhz6K+xGOFs6ormF1aapDFt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.23.0/LICENSE
```

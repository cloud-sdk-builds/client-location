...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qi2aJkzNaclk4iOojShqnSru1Jg2yK7hHFzqweVEzwofRsYhVxC0dVJI8LcjV3Lk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.629.0/index.min.mjs": "sha384-Qi2aJkzNaclk4iOojShqnSru1Jg2yK7hHFzqweVEzwofRsYhVxC0dVJI8LcjV3Lk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.629.0/LICENSE
```

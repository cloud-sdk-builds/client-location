...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AHABsJFAOpBAYE3IvW/ydU9Q6QuEaPv2dNTECUg9/jTnqHpFEISUBomn9k+iAgKu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.329.0/index.min.mjs": "sha384-AHABsJFAOpBAYE3IvW/ydU9Q6QuEaPv2dNTECUg9/jTnqHpFEISUBomn9k+iAgKu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.329.0/LICENSE
```

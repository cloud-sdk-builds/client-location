...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.87.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.87.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x7xnwpoeJ8JXWrXT00Luf6EoMQnQP+lfVrWJz9LyKEQ4LeFqoMH5zzoL58upfOR2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.87.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.87.0/index.min.mjs": "sha384-x7xnwpoeJ8JXWrXT00Luf6EoMQnQP+lfVrWJz9LyKEQ4LeFqoMH5zzoL58upfOR2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.87.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZJbJqUqNlCgQSebAk/BC7MAfv8fVYGbSEeZ2JqGAtPMUprluAnRALGscfhR2szsD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.954.0/index.min.mjs": "sha384-ZJbJqUqNlCgQSebAk/BC7MAfv8fVYGbSEeZ2JqGAtPMUprluAnRALGscfhR2szsD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.954.0/LICENSE
```

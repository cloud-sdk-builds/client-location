...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1035.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1035.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LQfYHM4ltM601dJ8E20hoICpqDvChpsbLl2sLO8blD7fdAxmqsrYECZmDsyP71v1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1035.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1035.0/index.min.mjs": "sha384-LQfYHM4ltM601dJ8E20hoICpqDvChpsbLl2sLO8blD7fdAxmqsrYECZmDsyP71v1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1035.0/LICENSE
```

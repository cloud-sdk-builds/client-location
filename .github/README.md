...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dUIZXr6Vt6qlMMYwjLGJgD3H6VQxbiZeracjlmNy7jFluCAqdgW1v4Y48k/DXH9g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.588.0/index.min.mjs": "sha384-dUIZXr6Vt6qlMMYwjLGJgD3H6VQxbiZeracjlmNy7jFluCAqdgW1v4Y48k/DXH9g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.588.0/LICENSE
```

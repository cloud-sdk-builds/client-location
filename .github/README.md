...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.369.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.369.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aOPXyn7+tmGDrK+V8pHtAOiOxNJNZBKx+64x85jYxNHNVun3jQj6LCUHhf+HwdKd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.369.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.369.0/index.min.mjs": "sha384-aOPXyn7+tmGDrK+V8pHtAOiOxNJNZBKx+64x85jYxNHNVun3jQj6LCUHhf+HwdKd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.369.0/LICENSE
```

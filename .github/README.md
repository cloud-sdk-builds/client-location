...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.565.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.565.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zQ+OYRINk5/WtEbWEe7cLdvTozx58uWS0QpANhShiCxkxt+QPYBs2b0HjuAz3P6x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.565.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.565.0/index.min.mjs": "sha384-zQ+OYRINk5/WtEbWEe7cLdvTozx58uWS0QpANhShiCxkxt+QPYBs2b0HjuAz3P6x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.565.0/LICENSE
```

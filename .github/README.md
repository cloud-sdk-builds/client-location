...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1042.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1042.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OELmp0gRXqrHIM3j1NrnlpYAYfjDPh9Wt8xv3xNCqpmlC/GpfgGUMZ71jcluhTPh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1042.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1042.0/index.min.mjs": "sha384-OELmp0gRXqrHIM3j1NrnlpYAYfjDPh9Wt8xv3xNCqpmlC/GpfgGUMZ71jcluhTPh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1042.0/LICENSE
```

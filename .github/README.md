...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1001.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1001.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gjGNxv7pQYXv0IhFf5bdNRskmDi3FeFPcXXZ9MtH74qvZXofLtokJEurhsyC2BHq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1001.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1001.0/index.min.mjs": "sha384-gjGNxv7pQYXv0IhFf5bdNRskmDi3FeFPcXXZ9MtH74qvZXofLtokJEurhsyC2BHq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1001.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-325Ohb+fVrh+7iawwjVFDuMYrwtPORggL9IGFxIKFu10hSkNA7ncR3a8YbGKKB7g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.744.0/index.min.mjs": "sha384-325Ohb+fVrh+7iawwjVFDuMYrwtPORggL9IGFxIKFu10hSkNA7ncR3a8YbGKKB7g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.744.0/LICENSE
```

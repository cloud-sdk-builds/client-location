...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aJ37rfB36g2ftyI5Cf+zKIcZC8Vn7fpcdQIi4dA6jS0w4lYBG3R4jOVIPQE6nB5E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.163.0/index.min.mjs": "sha384-aJ37rfB36g2ftyI5Cf+zKIcZC8Vn7fpcdQIi4dA6jS0w4lYBG3R4jOVIPQE6nB5E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.163.0/LICENSE
```

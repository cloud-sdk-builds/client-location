...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rDoGjwu9NcoqdgctLcXLlf7EZRWA6guOnOYMWrplaNTxiI8fdUzmM8Zxyq+Ru0Bx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.25.0/index.min.mjs": "sha384-rDoGjwu9NcoqdgctLcXLlf7EZRWA6guOnOYMWrplaNTxiI8fdUzmM8Zxyq+Ru0Bx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.25.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.344.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.344.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GhdghGE4xFc/GwfylF3Nv0qTxeuKIyB6uvba4He626IFkWnlD5g/v65ArgdYuVB3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.344.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.344.0/index.min.mjs": "sha384-GhdghGE4xFc/GwfylF3Nv0qTxeuKIyB6uvba4He626IFkWnlD5g/v65ArgdYuVB3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.344.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.42.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.42.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RGZYJysMS3HW8Bf3QLmowfmr09+NQ6Y8xCnEmfppYAS3aZM/7w57XvppS3/zdm7J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.42.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.42.0/index.min.mjs": "sha384-RGZYJysMS3HW8Bf3QLmowfmr09+NQ6Y8xCnEmfppYAS3aZM/7w57XvppS3/zdm7J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.42.0/LICENSE
```

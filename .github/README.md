...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.804.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.804.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cm3NlU8Dd2s000Ny1mMBs0zxSDQ1KNBPJ42/MAUxrju6RN1wHYyZAogUIxeQ/koh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.804.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.804.0/index.min.mjs": "sha384-cm3NlU8Dd2s000Ny1mMBs0zxSDQ1KNBPJ42/MAUxrju6RN1wHYyZAogUIxeQ/koh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.804.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.141.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.141.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8OZzuCN8auBkTxy5CZgu7efJd6N9DWVzFc/itfoOGxnG4nrrkHUq36u1eq3tHNEh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.141.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.141.0/index.min.mjs": "sha384-8OZzuCN8auBkTxy5CZgu7efJd6N9DWVzFc/itfoOGxnG4nrrkHUq36u1eq3tHNEh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.141.0/LICENSE
```

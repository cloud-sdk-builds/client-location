...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.503.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.503.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Kh3/h+feSDLw71gKQ2w3gA2pStVyYEA0K6f/6CnEOeyvIv8hPyyl8HUKVKve1lR8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.503.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.503.0/index.min.mjs": "sha384-Kh3/h+feSDLw71gKQ2w3gA2pStVyYEA0K6f/6CnEOeyvIv8hPyyl8HUKVKve1lR8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.503.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e6YqtEVWUDQgP8oPWie6gXTt5O6CRVygJjof71WwVBqTSF6Uq9r0ccphtS15Hvad
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.692.0/index.min.mjs": "sha384-e6YqtEVWUDQgP8oPWie6gXTt5O6CRVygJjof71WwVBqTSF6Uq9r0ccphtS15Hvad"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.692.0/LICENSE
```

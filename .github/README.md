...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5HS2Z5N7tws1SN830EN9QQZqYiAeoMKolkhvJ85V558fba8Mhxe3QhcaWxYhdjJZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.335.0/index.min.mjs": "sha384-5HS2Z5N7tws1SN830EN9QQZqYiAeoMKolkhvJ85V558fba8Mhxe3QhcaWxYhdjJZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.335.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.48.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.48.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HOAbZH63yc9euOJwK5XUOlCbz+gJDuq9O7x8pIhRQvIaEgJ3AxoOQe9Fs3Llbny8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.48.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.48.0/index.min.mjs": "sha384-HOAbZH63yc9euOJwK5XUOlCbz+gJDuq9O7x8pIhRQvIaEgJ3AxoOQe9Fs3Llbny8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.48.0/LICENSE
```

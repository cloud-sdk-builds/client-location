...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0A4ZsMCugYDZRJf3PiC6wpS+ELWwFwOUkDY8+FpbrUuz7VXDVhlXmT22RzpO9XyT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.988.0/index.min.mjs": "sha384-0A4ZsMCugYDZRJf3PiC6wpS+ELWwFwOUkDY8+FpbrUuz7VXDVhlXmT22RzpO9XyT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.988.0/LICENSE
```

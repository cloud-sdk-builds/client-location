...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.80.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.80.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Fyz6EOmZALvfgikhCG7/Fl4tY6uc22qTdl9WkmFp8zIcUWAbdm7ywEGLU9NP/8X4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.80.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.80.0/index.min.mjs": "sha384-Fyz6EOmZALvfgikhCG7/Fl4tY6uc22qTdl9WkmFp8zIcUWAbdm7ywEGLU9NP/8X4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.80.0/LICENSE
```

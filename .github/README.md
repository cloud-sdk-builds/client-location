...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2/NXaOegyABblrBObQKr40HzoWnU57kEB1dc4JSazAyrC1G3bUXpZeYfH3LGNYYn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.991.0/index.min.mjs": "sha384-2/NXaOegyABblrBObQKr40HzoWnU57kEB1dc4JSazAyrC1G3bUXpZeYfH3LGNYYn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.991.0/LICENSE
```

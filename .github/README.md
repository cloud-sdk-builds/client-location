...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1023.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1023.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hWqkNUFh0ZS3fU/yB73w1O66V4tsDIF4FhSyyiQ+nAZM9lGSiGkBkCDXFCckCO71
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1023.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1023.0/index.min.mjs": "sha384-hWqkNUFh0ZS3fU/yB73w1O66V4tsDIF4FhSyyiQ+nAZM9lGSiGkBkCDXFCckCO71"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1023.0/LICENSE
```

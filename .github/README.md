...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DtUMSP5hUx2I2oMzdc6Sqg4yleS6pINJwGI1aCDUnUTQVEXwFPC141XlOpShDCCg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.645.0/index.min.mjs": "sha384-DtUMSP5hUx2I2oMzdc6Sqg4yleS6pINJwGI1aCDUnUTQVEXwFPC141XlOpShDCCg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.645.0/LICENSE
```

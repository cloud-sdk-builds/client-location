...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pU2tgEKHqm8BzngpixTuQPbHGNgppUdCp/FiDVYzmf5dJFcgy8+qk9nHT2XPP7e9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.990.0/index.min.mjs": "sha384-pU2tgEKHqm8BzngpixTuQPbHGNgppUdCp/FiDVYzmf5dJFcgy8+qk9nHT2XPP7e9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.990.0/LICENSE
```

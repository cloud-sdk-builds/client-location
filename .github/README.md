...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.391.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.391.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-szbWvB4gvo78ENe+FdxnIzE+EnsdZqbUqZ13fy8XB0P3GOhQAmdn8dYXNzFZahqW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.391.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.391.0/index.min.mjs": "sha384-szbWvB4gvo78ENe+FdxnIzE+EnsdZqbUqZ13fy8XB0P3GOhQAmdn8dYXNzFZahqW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.391.0/LICENSE
```

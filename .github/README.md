...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.39.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.39.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bi9bJ9hfCd2i5oBZjYvEdobtK/fpCmOitKG22UV8VjK6uo0w1u/BgD0XDLAXIHBN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.39.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.39.0/index.min.mjs": "sha384-bi9bJ9hfCd2i5oBZjYvEdobtK/fpCmOitKG22UV8VjK6uo0w1u/BgD0XDLAXIHBN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.39.0/LICENSE
```

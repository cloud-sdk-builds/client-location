...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.21.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.21.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1mawSffuuhPh+d7uQGTVAiHWTjDHw5tXD9ljbOSD3a+/rCwRbiZTXPvYh5XKNdG6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.21.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.21.0/index.min.mjs": "sha384-1mawSffuuhPh+d7uQGTVAiHWTjDHw5tXD9ljbOSD3a+/rCwRbiZTXPvYh5XKNdG6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.21.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-24dko3cO22hlUWZ1xWkTz0Gjrwc3aXaSHfaIjX1KQC14B8+i+s2CnejF1wJuEQ0o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.20.0/index.min.mjs": "sha384-24dko3cO22hlUWZ1xWkTz0Gjrwc3aXaSHfaIjX1KQC14B8+i+s2CnejF1wJuEQ0o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.20.0/LICENSE
```

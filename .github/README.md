...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TFKuTLDLgqR1GA6zYpf6Tt97TZCdd9Kx/stbwm2zOcRBiGD3N49nyhUVZYTskT4v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.385.0/index.min.mjs": "sha384-TFKuTLDLgqR1GA6zYpf6Tt97TZCdd9Kx/stbwm2zOcRBiGD3N49nyhUVZYTskT4v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.385.0/LICENSE
```

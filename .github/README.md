...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1024.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1024.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hk+LyV3UYGASUQ1v4CI/ka/yv/pD0FQ6KzxwkFkcbJOQ13RHi3fawR7/GbGzhl2z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1024.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1024.0/index.min.mjs": "sha384-hk+LyV3UYGASUQ1v4CI/ka/yv/pD0FQ6KzxwkFkcbJOQ13RHi3fawR7/GbGzhl2z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1024.0/LICENSE
```

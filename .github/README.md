...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WSy/eqJbcHWMMpKvIyspUgpf/c1x4rX9y8Fx4D65GiLizB5jdYrVlaiHkubAMIKQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.926.0/index.min.mjs": "sha384-WSy/eqJbcHWMMpKvIyspUgpf/c1x4rX9y8Fx4D65GiLizB5jdYrVlaiHkubAMIKQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.926.0/LICENSE
```

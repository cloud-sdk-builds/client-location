...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.438.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.438.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PC3Ywr5k4mcMhqP9Im4U/FBGyWlxCUr0w+x/7Rc9I/Fwh0ISdEwjw2Ls6oT08+Pg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.438.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.438.0/index.min.mjs": "sha384-PC3Ywr5k4mcMhqP9Im4U/FBGyWlxCUr0w+x/7Rc9I/Fwh0ISdEwjw2Ls6oT08+Pg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.438.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UWLVyMS2DoV5hIjaLmMGEr21ginzhSO/AEEPEL8JkvWQ8zQ+QahQC9a+IvyhiQuL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.921.0/index.min.mjs": "sha384-UWLVyMS2DoV5hIjaLmMGEr21ginzhSO/AEEPEL8JkvWQ8zQ+QahQC9a+IvyhiQuL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.921.0/LICENSE
```

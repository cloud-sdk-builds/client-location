...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1039.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1039.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0dLX3WrsFzSGdsqD21tKdKjLkbz65WyNkHLnsjUIf70NFDLDnY3HnxCWo2rNZ+ZT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1039.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1039.0/index.min.mjs": "sha384-0dLX3WrsFzSGdsqD21tKdKjLkbz65WyNkHLnsjUIf70NFDLDnY3HnxCWo2rNZ+ZT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1039.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.38.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.38.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yhX8oH+7o+9Ms6y8HcDo7RxryvFx8OczPapByq6k6yzc6VddSYnAktrN/SyBHwBq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.38.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.38.0/index.min.mjs": "sha384-yhX8oH+7o+9Ms6y8HcDo7RxryvFx8OczPapByq6k6yzc6VddSYnAktrN/SyBHwBq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.38.0/LICENSE
```

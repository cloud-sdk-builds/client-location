...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XN7tzpo0Yn88q/ecd/XPLT+w2y0DoYKXvQK5RwBYhKZwJqBi5qIi9BBEBYp3cT4L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.606.0/index.min.mjs": "sha384-XN7tzpo0Yn88q/ecd/XPLT+w2y0DoYKXvQK5RwBYhKZwJqBi5qIi9BBEBYp3cT4L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.606.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dM9Y2B0foJ72MVR4Sg0e/VQtbXU9xCx35oeqRuORJ9ZPF1TiuN0eXeEs+oMOqFC0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.16.0/index.min.mjs": "sha384-dM9Y2B0foJ72MVR4Sg0e/VQtbXU9xCx35oeqRuORJ9ZPF1TiuN0eXeEs+oMOqFC0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.16.0/LICENSE
```

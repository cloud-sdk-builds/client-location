...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GTGv6Cqk0AKGw5AKeMbkjbW/JyF89MW+K4wZKFdNOuZI2s4HKRdnXDwLLk690QBe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.907.0/index.min.mjs": "sha384-GTGv6Cqk0AKGw5AKeMbkjbW/JyF89MW+K4wZKFdNOuZI2s4HKRdnXDwLLk690QBe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.907.0/LICENSE
```

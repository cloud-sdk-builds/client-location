...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.209.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.209.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tWT4hmyz754ww9roqQjxxZFmgqMruCSU4YZVyM/Mp/wFx70Wz5144XsqJSbYzlQ3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.209.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.209.0/index.min.mjs": "sha384-tWT4hmyz754ww9roqQjxxZFmgqMruCSU4YZVyM/Mp/wFx70Wz5144XsqJSbYzlQ3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.209.0/LICENSE
```

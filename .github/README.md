...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.451.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.451.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jLa801M2Ez3nnPHqne8M738ksLtpejvfjOEr3n+MIZ1CrxE4D5mUFJban+AH/iUe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.451.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.451.0/index.min.mjs": "sha384-jLa801M2Ez3nnPHqne8M738ksLtpejvfjOEr3n+MIZ1CrxE4D5mUFJban+AH/iUe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.451.0/LICENSE
```

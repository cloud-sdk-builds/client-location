...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sRK70sYqjyu7csdNwSdpbhbbtm+wHVsrK1WePoohvGCLpEId0afk+48EhFqE0fla
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.496.0/index.min.mjs": "sha384-sRK70sYqjyu7csdNwSdpbhbbtm+wHVsrK1WePoohvGCLpEId0afk+48EhFqE0fla"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.496.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-laRjmzQwEvDAGrIaC8RUnFdEhrJh6BuW04u4idiQhv2nGpxaxZiCoobT0pLNMUA2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.22.0/index.min.mjs": "sha384-laRjmzQwEvDAGrIaC8RUnFdEhrJh6BuW04u4idiQhv2nGpxaxZiCoobT0pLNMUA2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.22.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.362.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.362.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u6vMUNNDumxAulnyrsAVrbZFYo3pxjNSp7q19n0hkcjTE/ihxVtc6DC71fDIOsB+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.362.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.362.0/index.min.mjs": "sha384-u6vMUNNDumxAulnyrsAVrbZFYo3pxjNSp7q19n0hkcjTE/ihxVtc6DC71fDIOsB+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.362.0/LICENSE
```

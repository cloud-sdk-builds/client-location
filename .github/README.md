...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I0GQwJ2dlOHqRzXwQ64/ZJxuG0XMOh2DgxmNwEvriRveoD1njDZxKbxGHcO5ipCm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.964.0/index.min.mjs": "sha384-I0GQwJ2dlOHqRzXwQ64/ZJxuG0XMOh2DgxmNwEvriRveoD1njDZxKbxGHcO5ipCm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.964.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lts8G5T3ngxkawPi+xcdcgfOeS7KoAbRBFP129Om3ckigiqYG0wLK4I0qmBlRK83
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.484.0/index.min.mjs": "sha384-lts8G5T3ngxkawPi+xcdcgfOeS7KoAbRBFP129Om3ckigiqYG0wLK4I0qmBlRK83"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.484.0/LICENSE
```

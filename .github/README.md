...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WDQ98CFFofDv/02QIxjVMsELHMVJKAfMjnW/us8DVTtINUAsh1eZpM7j/gsdvPZA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.658.0/index.min.mjs": "sha384-WDQ98CFFofDv/02QIxjVMsELHMVJKAfMjnW/us8DVTtINUAsh1eZpM7j/gsdvPZA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.658.0/LICENSE
```

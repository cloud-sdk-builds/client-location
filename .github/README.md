...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.186.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.186.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PQZHbrlXjX6kIM7kaj/NannfeAHfQuAVeEd1QpGdrGT6LgWymw2zeuGx/Abr2lUb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.186.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.186.0/index.min.mjs": "sha384-PQZHbrlXjX6kIM7kaj/NannfeAHfQuAVeEd1QpGdrGT6LgWymw2zeuGx/Abr2lUb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.186.0/LICENSE
```

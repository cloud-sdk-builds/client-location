...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.258.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.258.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+t20yNOGI7OVoutLCIszQBD9FRtlDq1bQ2nZxk53HYRy0abazT3U/qifKL6TThuK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.258.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.258.0/index.min.mjs": "sha384-+t20yNOGI7OVoutLCIszQBD9FRtlDq1bQ2nZxk53HYRy0abazT3U/qifKL6TThuK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.258.0/LICENSE
```

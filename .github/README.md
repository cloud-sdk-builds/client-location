...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AzWYYkoRRYxQ6y2ASp74IaGvb+B2vw1Nwmsm6a/92nNOXUZF7VNtIUV3RksSHgRm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.572.0/index.min.mjs": "sha384-AzWYYkoRRYxQ6y2ASp74IaGvb+B2vw1Nwmsm6a/92nNOXUZF7VNtIUV3RksSHgRm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.572.0/LICENSE
```

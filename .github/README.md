...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7bl8BGPSst7RscrTvOW47Xo3xPndZ4Nudk7EaYVaHgg3ueSLzCES+hKUEy0XkF5F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.327.0/index.min.mjs": "sha384-7bl8BGPSst7RscrTvOW47Xo3xPndZ4Nudk7EaYVaHgg3ueSLzCES+hKUEy0XkF5F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.327.0/LICENSE
```

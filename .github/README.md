...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.332.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.332.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p4DPX3jcyRLPo/wECsyygVPtNRJpHa1xYeU2Eot6eFobIq4Doj5kmJ9Bmifagyvo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.332.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.332.0/index.min.mjs": "sha384-p4DPX3jcyRLPo/wECsyygVPtNRJpHa1xYeU2Eot6eFobIq4Doj5kmJ9Bmifagyvo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.332.0/LICENSE
```

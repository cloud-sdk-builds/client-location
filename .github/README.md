...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ogQeafkqX7GhOsDOrsq/psGOua5P80lF4eE0aVweR89p4yNsmHnevc1R9TllSnYh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.254.0/index.min.mjs": "sha384-ogQeafkqX7GhOsDOrsq/psGOua5P80lF4eE0aVweR89p4yNsmHnevc1R9TllSnYh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.254.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d0bRsKFT1rQq2l9rNN8T9iIjBwhfPUARv/k093mR6U17na1e9Ybm6VdWn716jm+X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.913.0/index.min.mjs": "sha384-d0bRsKFT1rQq2l9rNN8T9iIjBwhfPUARv/k093mR6U17na1e9Ybm6VdWn716jm+X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.913.0/LICENSE
```

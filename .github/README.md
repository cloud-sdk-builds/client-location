...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nanhqLv9v1lvp0ZMSUwKNmOxLX8ZPhhAPAqtdKHikeN97LKPrm8GV+1L2E2PgENt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.504.0/index.min.mjs": "sha384-nanhqLv9v1lvp0ZMSUwKNmOxLX8ZPhhAPAqtdKHikeN97LKPrm8GV+1L2E2PgENt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.504.0/LICENSE
```

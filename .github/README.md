...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+ZGDZaCDNtEW1t8VcCJJrVUHCi4q0Y1eEGelS8fmO37f8KGjZr/l7DAkT+lGYpXx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.278.0/index.min.mjs": "sha384-+ZGDZaCDNtEW1t8VcCJJrVUHCi4q0Y1eEGelS8fmO37f8KGjZr/l7DAkT+lGYpXx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.278.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pdGd450oc2oiZhs6qBnNdYU/njLJMl6oGal2GlSxOfxFc3bXjbKcQOMow1Qbzf5V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.137.0/index.min.mjs": "sha384-pdGd450oc2oiZhs6qBnNdYU/njLJMl6oGal2GlSxOfxFc3bXjbKcQOMow1Qbzf5V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.137.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AwfU5uzHJeN6atWnB2Uxncfnhk12jE1iwE+gN0PvAYYjcZdciDihVpvW15SDJMhr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.398.0/index.min.mjs": "sha384-AwfU5uzHJeN6atWnB2Uxncfnhk12jE1iwE+gN0PvAYYjcZdciDihVpvW15SDJMhr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.398.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tvSkEFzCn0nL9poBNTTDJ3FHhAHg3Dt/ie8bpa5uxoiTf8tvmqiIZBGRzESXyPLX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.649.0/index.min.mjs": "sha384-tvSkEFzCn0nL9poBNTTDJ3FHhAHg3Dt/ie8bpa5uxoiTf8tvmqiIZBGRzESXyPLX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.649.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.74.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.74.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cgnxz3yknqynrng41jq2ySwIpsDkqXQtzwjbh/FtiQzg7r1SuVjzcayIFEG+wYjv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.74.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.74.0/index.min.mjs": "sha384-cgnxz3yknqynrng41jq2ySwIpsDkqXQtzwjbh/FtiQzg7r1SuVjzcayIFEG+wYjv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.74.0/LICENSE
```

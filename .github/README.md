...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UF6i2exKx/EC+Kpe8i7yb9UXZJOw5HgmJCLmI+3SotgGai66jg4+ZKKv9875juBu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.928.0/index.min.mjs": "sha384-UF6i2exKx/EC+Kpe8i7yb9UXZJOw5HgmJCLmI+3SotgGai66jg4+ZKKv9875juBu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.928.0/LICENSE
```

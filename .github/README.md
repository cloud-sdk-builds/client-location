...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1011.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1011.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WCL4Yo/AP60dvDq0X3FsooTgv4JZODZ3UdNaY9IRXG+jPJ3ZbErVrM9WjmURbG04
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1011.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1011.0/index.min.mjs": "sha384-WCL4Yo/AP60dvDq0X3FsooTgv4JZODZ3UdNaY9IRXG+jPJ3ZbErVrM9WjmURbG04"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1011.0/LICENSE
```

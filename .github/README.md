...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.502.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.502.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TpgISPrJW2g0g4zWlC1Jl2e4fbBP1fC/49Xg3TIAxnL8pijmoRGAq9WfBHgRrrI2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.502.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.502.0/index.min.mjs": "sha384-TpgISPrJW2g0g4zWlC1Jl2e4fbBP1fC/49Xg3TIAxnL8pijmoRGAq9WfBHgRrrI2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.502.0/LICENSE
```

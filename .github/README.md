...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c/rqDeN85ckAq2Dgf/iWDgcvWHR4A2Vbdqlx2GdzjAuz5IXWq33TZAo7KdTqstBe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.337.0/index.min.mjs": "sha384-c/rqDeN85ckAq2Dgf/iWDgcvWHR4A2Vbdqlx2GdzjAuz5IXWq33TZAo7KdTqstBe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.337.0/LICENSE
```

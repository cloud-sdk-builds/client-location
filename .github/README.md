...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FE0IxqO1QtBeDPpGdGzAzNkic0cNlq4jH4G25UtQI2XcY8Vh6d8w9LLiSK6ef+jW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.587.0/index.min.mjs": "sha384-FE0IxqO1QtBeDPpGdGzAzNkic0cNlq4jH4G25UtQI2XcY8Vh6d8w9LLiSK6ef+jW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.587.0/LICENSE
```

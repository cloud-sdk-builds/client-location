...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.95.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.95.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l9Wb9Sf4hrD6eh25h1e1d8RnQyn9fJYEoWKLXdXUCqd80X2JunXP5Sai96DePhfg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.95.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.95.0/index.min.mjs": "sha384-l9Wb9Sf4hrD6eh25h1e1d8RnQyn9fJYEoWKLXdXUCqd80X2JunXP5Sai96DePhfg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.95.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-neFKGYqA5vS8/cEL2DomG3VvoARgVaQEF5R7DTHEw476ZHxbgpSZmYjf82ZmCIpT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.554.0/index.min.mjs": "sha384-neFKGYqA5vS8/cEL2DomG3VvoARgVaQEF5R7DTHEw476ZHxbgpSZmYjf82ZmCIpT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.554.0/LICENSE
```

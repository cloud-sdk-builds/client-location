...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xrWTT1wCZ6Aql98sMgjUHuwMNKA9NBt7gViu4U8pveu6+L4JK1zhD0CxLsEuelb2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.43.0/index.min.mjs": "sha384-xrWTT1wCZ6Aql98sMgjUHuwMNKA9NBt7gViu4U8pveu6+L4JK1zhD0CxLsEuelb2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.43.0/LICENSE
```

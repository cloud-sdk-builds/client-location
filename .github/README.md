...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.939.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.939.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zh/139WoBikDq5Nfs7RyNS3dVK4WprWEVY+O8XWkz7lfzsdOgct7XPSVliXF3Q5z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.939.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.939.0/index.min.mjs": "sha384-zh/139WoBikDq5Nfs7RyNS3dVK4WprWEVY+O8XWkz7lfzsdOgct7XPSVliXF3Q5z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.939.0/LICENSE
```

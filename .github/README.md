...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6TuCLdYLNbU//Wlpbc13tr/f0VBybNWBDRwe9MQT3RdMK/2EWW4yWZ360VGer9dq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.911.0/index.min.mjs": "sha384-6TuCLdYLNbU//Wlpbc13tr/f0VBybNWBDRwe9MQT3RdMK/2EWW4yWZ360VGer9dq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.911.0/LICENSE
```

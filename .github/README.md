...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1017.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1017.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SVzHYIYWyy89UXQ2GFmLIxELTR3YCpORczNaw2WCr0rYjyIquuWPAMh2HBt5/ul+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1017.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1017.0/index.min.mjs": "sha384-SVzHYIYWyy89UXQ2GFmLIxELTR3YCpORczNaw2WCr0rYjyIquuWPAMh2HBt5/ul+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1017.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.917.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.917.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qm74OG6xMN5vDoRlrprqywMXjjbYh+5SFYLgjXz9fbnBcLOQCRIO0gYdajDzQnXW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.917.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.917.0/index.min.mjs": "sha384-qm74OG6xMN5vDoRlrprqywMXjjbYh+5SFYLgjXz9fbnBcLOQCRIO0gYdajDzQnXW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.917.0/LICENSE
```

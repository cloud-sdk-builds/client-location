...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bgv9pyeULMMZucwrVRaRL+bph8ZQSQGscrjLt0FwbKiqwlI/KiDk+29jRBj9FAjn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.32.0/index.min.mjs": "sha384-Bgv9pyeULMMZucwrVRaRL+bph8ZQSQGscrjLt0FwbKiqwlI/KiDk+29jRBj9FAjn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.32.0/LICENSE
```

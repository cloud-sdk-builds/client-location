...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vncm4oJVHlyAum0/4VK/Tn/mr1urQrLSZLn/zgE0l8a+NM0Q9KF3phdbNLFGfGdX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.358.0/index.min.mjs": "sha384-vncm4oJVHlyAum0/4VK/Tn/mr1urQrLSZLn/zgE0l8a+NM0Q9KF3phdbNLFGfGdX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.358.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.301.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.301.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8HMnozABefjbpZ+Tt9DeJj+n4ArI6iMbYLHpWCxeumJITxkifh6h8peF9XHmCHvS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.301.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.301.0/index.min.mjs": "sha384-8HMnozABefjbpZ+Tt9DeJj+n4ArI6iMbYLHpWCxeumJITxkifh6h8peF9XHmCHvS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.301.0/LICENSE
```

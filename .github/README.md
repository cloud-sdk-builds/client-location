...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.276.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.276.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-plvJngVfdhxJjhLqfXaw8j6YZTSndpRr1efb+fIOTx/rUub5KhytVhLv+bvNaUdx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.276.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.276.0/index.min.mjs": "sha384-plvJngVfdhxJjhLqfXaw8j6YZTSndpRr1efb+fIOTx/rUub5KhytVhLv+bvNaUdx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.276.0/LICENSE
```

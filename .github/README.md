...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vy7Oi3Tcuo/CSPF1Lpt1nH1G7so9SqdipOBisRSUy3t/aVM79bUP0xFL4y4wQOkB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.112.0/index.min.mjs": "sha384-vy7Oi3Tcuo/CSPF1Lpt1nH1G7so9SqdipOBisRSUy3t/aVM79bUP0xFL4y4wQOkB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.112.0/LICENSE
```

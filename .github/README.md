...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.296.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.296.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nztwPauhS9XCC+IhtIYOOgyc0/Bbf5JrwsVVPrH6uxnKaNuCHGHpoct9d3Q3bZhp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.296.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.296.0/index.min.mjs": "sha384-nztwPauhS9XCC+IhtIYOOgyc0/Bbf5JrwsVVPrH6uxnKaNuCHGHpoct9d3Q3bZhp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.296.0/LICENSE
```

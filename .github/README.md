...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hyXzxudeha5MRwSrIuEQTgk2CyV/0aDh8byXH9lMTgCYyQsz8AFLl29qPSkrOxOV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.27.0/index.min.mjs": "sha384-hyXzxudeha5MRwSrIuEQTgk2CyV/0aDh8byXH9lMTgCYyQsz8AFLl29qPSkrOxOV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.27.0/LICENSE
```

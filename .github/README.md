...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uheU9sYz0o56y+gfk/nG41OzQsPPevqeo8pahf5EmIRkBQY7sBvYwkbPrt/ypdwS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.386.0/index.min.mjs": "sha384-uheU9sYz0o56y+gfk/nG41OzQsPPevqeo8pahf5EmIRkBQY7sBvYwkbPrt/ypdwS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.386.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O0wknksB8p1C74rBINeWUFMe/uBV8ggcqPNkR9wB/3LNTOgy+rvP34uDzBgJ5yd5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.299.0/index.min.mjs": "sha384-O0wknksB8p1C74rBINeWUFMe/uBV8ggcqPNkR9wB/3LNTOgy+rvP34uDzBgJ5yd5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.299.0/LICENSE
```

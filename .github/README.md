...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.529.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.529.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-02iAAMU77CmDs0t2Sg8FvZjjDWaDFNSRCObW4l4D//Z7Kx2zd9xGNChyrIs5tfTy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.529.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.529.1/index.min.mjs": "sha384-02iAAMU77CmDs0t2Sg8FvZjjDWaDFNSRCObW4l4D//Z7Kx2zd9xGNChyrIs5tfTy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.529.1/LICENSE
```

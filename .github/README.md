...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.669.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.669.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TtOgjHJWCLUdQwd0p9KKKcq3o5aTIFTw26sDmkN7mkj+vIcUIKxkmsRfryLbdGF8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.669.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.669.0/index.min.mjs": "sha384-TtOgjHJWCLUdQwd0p9KKKcq3o5aTIFTw26sDmkN7mkj+vIcUIKxkmsRfryLbdGF8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.669.0/LICENSE
```

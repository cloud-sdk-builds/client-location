...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eK4QV3TN3YjRNDrcQ5vBXIfqLp1e8GGKh8OVSVL5ClTQa7i1ibeNoiTTSPJMkqF1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.984.0/index.min.mjs": "sha384-eK4QV3TN3YjRNDrcQ5vBXIfqLp1e8GGKh8OVSVL5ClTQa7i1ibeNoiTTSPJMkqF1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.984.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hG4A1YxZoVBMDWpqklr5dnnq0t3KUVm1itXmpmj9hkBvUphmpm+4IyD5WtMeWkU6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.359.0/index.min.mjs": "sha384-hG4A1YxZoVBMDWpqklr5dnnq0t3KUVm1itXmpmj9hkBvUphmpm+4IyD5WtMeWkU6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.359.0/LICENSE
```

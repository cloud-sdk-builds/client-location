...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/e/PParzxdQxGUYifJLmzbj00O3Co12J3RRg1dfIiLV3W+XtZYYjQZ/8ghpUHBrl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.50.0/index.min.mjs": "sha384-/e/PParzxdQxGUYifJLmzbj00O3Co12J3RRg1dfIiLV3W+XtZYYjQZ/8ghpUHBrl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.50.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6U2Crr9chjtD4fzLW/5tyTmFl0AbdJM3Le//DHxT5vCd/t6HNCDlWtfnnexSvo5K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.378.0/index.min.mjs": "sha384-6U2Crr9chjtD4fzLW/5tyTmFl0AbdJM3Le//DHxT5vCd/t6HNCDlWtfnnexSvo5K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.378.0/LICENSE
```

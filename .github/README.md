...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.693.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.693.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4sbRp0QTrVlLnva3lyVvwl4oSds3C94fCLcw3yiWzClkxR2j0kuouM5kMES8SLyG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.693.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.693.0/index.min.mjs": "sha384-4sbRp0QTrVlLnva3lyVvwl4oSds3C94fCLcw3yiWzClkxR2j0kuouM5kMES8SLyG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.693.0/LICENSE
```

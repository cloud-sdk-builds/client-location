...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hu9CaNzXnRrJg2rSM7wubTb8RnXE2rMMXB4J757kr1/MHLyFAU6ZpXfce2Sq1LVm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.525.0/index.min.mjs": "sha384-Hu9CaNzXnRrJg2rSM7wubTb8RnXE2rMMXB4J757kr1/MHLyFAU6ZpXfce2Sq1LVm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.525.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tKQZ4wWp+z54qyky5S6KrgmLP+lMS6HnJOwheHWNUhTcsPTBQHaz0spTg4QZ8GWq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.377.0/index.min.mjs": "sha384-tKQZ4wWp+z54qyky5S6KrgmLP+lMS6HnJOwheHWNUhTcsPTBQHaz0spTg4QZ8GWq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.377.0/LICENSE
```

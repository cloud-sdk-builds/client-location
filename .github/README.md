...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Paj6CnMWI2dAEjOwVOLuGiweKtYeLmi6e0IMT7BRNXz1xN3d3rUB0nbaaciG0XTT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.325.0/index.min.mjs": "sha384-Paj6CnMWI2dAEjOwVOLuGiweKtYeLmi6e0IMT7BRNXz1xN3d3rUB0nbaaciG0XTT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.325.0/LICENSE
```

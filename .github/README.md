...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1015.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1015.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QOff1jElj+1b9MGzPcIeUzTla7M5cuf0qf1ioN4htvEwexZBYDOYLfUU7WzKR520
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1015.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1015.0/index.min.mjs": "sha384-QOff1jElj+1b9MGzPcIeUzTla7M5cuf0qf1ioN4htvEwexZBYDOYLfUU7WzKR520"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1015.0/LICENSE
```

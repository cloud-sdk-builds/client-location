...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-x8UsaX1Kb9XZ9SHof9++SWLncP1GPXDLPGCBoIDBlnbuEAKh1yVEzJPYq1qRibsP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.503.1/index.min.mjs": "sha384-x8UsaX1Kb9XZ9SHof9++SWLncP1GPXDLPGCBoIDBlnbuEAKh1yVEzJPYq1qRibsP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.503.1/LICENSE
```

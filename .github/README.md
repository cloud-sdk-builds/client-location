...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EbtbTzYYMiZOr74JZ9emjnAZkfNlKpRdJ9EexRjC3jfiMTSlAY3KZgqz3Fg3evEV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.712.0/index.min.mjs": "sha384-EbtbTzYYMiZOr74JZ9emjnAZkfNlKpRdJ9EexRjC3jfiMTSlAY3KZgqz3Fg3evEV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.712.0/LICENSE
```

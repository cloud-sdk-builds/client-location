...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.980.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.980.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EttFNpbFuwSwDD+bbzAbNOVlSK8dmF6vAftsar5ZOY3GhvEvsyWlVDa0vzcaLkbR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.980.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.980.0/index.min.mjs": "sha384-EttFNpbFuwSwDD+bbzAbNOVlSK8dmF6vAftsar5ZOY3GhvEvsyWlVDa0vzcaLkbR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.980.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.348.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.348.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d5Qk6PwMZ8AG8qgzDae+w3DsF1OWLlDqtUH31ZVKjyWfxhnmtb6DCIgxGKgZux9t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.348.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.348.0/index.min.mjs": "sha384-d5Qk6PwMZ8AG8qgzDae+w3DsF1OWLlDqtUH31ZVKjyWfxhnmtb6DCIgxGKgZux9t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.348.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.421.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.421.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zwqXljPe1wViD2JV3JpUHl35bQNACsw7PgMkhlj6P3tchFcUVvjjTMKCl89d79R5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.421.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.421.0/index.min.mjs": "sha384-zwqXljPe1wViD2JV3JpUHl35bQNACsw7PgMkhlj6P3tchFcUVvjjTMKCl89d79R5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.421.0/LICENSE
```

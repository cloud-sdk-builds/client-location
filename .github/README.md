...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FWWsjMKNMBXM1+WGxsmK4yUGmjUdPmVTQ0M0davyXBDGy0ScU32eHpuuS2glUBiZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.576.0/index.min.mjs": "sha384-FWWsjMKNMBXM1+WGxsmK4yUGmjUdPmVTQ0M0davyXBDGy0ScU32eHpuuS2glUBiZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.576.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.30.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.30.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SrTrV2+ZsutTnkIkucm1ttwivRGpf6Z1JY9dyrWupjlmjreQn8ZAt1vcVJo51Tc0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.30.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.30.0/index.min.mjs": "sha384-SrTrV2+ZsutTnkIkucm1ttwivRGpf6Z1JY9dyrWupjlmjreQn8ZAt1vcVJo51Tc0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.30.0/LICENSE
```

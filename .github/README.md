...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.109.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.109.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lGJrZTFKaOLf3lgPvM4nVUZqYZYKXJTO1lubn9wGs7YDH2lZVJGfzXl16XJcItke
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.109.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.109.0/index.min.mjs": "sha384-lGJrZTFKaOLf3lgPvM4nVUZqYZYKXJTO1lubn9wGs7YDH2lZVJGfzXl16XJcItke"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.109.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nuTMwGDKS5tIQI//s6uTF7RCPqtx0ZJwjAC6oT8z9XvVdoMwBkuXHKejYt6b1lWa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.53.0/index.min.mjs": "sha384-nuTMwGDKS5tIQI//s6uTF7RCPqtx0ZJwjAC6oT8z9XvVdoMwBkuXHKejYt6b1lWa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.53.0/LICENSE
```

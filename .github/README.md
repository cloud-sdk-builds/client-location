...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Obgp5YYWMwYrjopPioUXIPEpuM/2i/qcZPpTSwX1td/QvXcbDB+3NPZpnN4VxHuh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.667.0/index.min.mjs": "sha384-Obgp5YYWMwYrjopPioUXIPEpuM/2i/qcZPpTSwX1td/QvXcbDB+3NPZpnN4VxHuh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.667.0/LICENSE
```

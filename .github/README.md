...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.295.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.295.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hZ2vQ2UJEsMCDUQPHaH6lBNYuKmyQDpju3y5alNPyQSmUa0F1ByAXF4CxmP6Hcj/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.295.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.295.0/index.min.mjs": "sha384-hZ2vQ2UJEsMCDUQPHaH6lBNYuKmyQDpju3y5alNPyQSmUa0F1ByAXF4CxmP6Hcj/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.295.0/LICENSE
```

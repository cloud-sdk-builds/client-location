...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ffBshQVeMPRmvhvPDeF6I1Dq88O1ASmmjv+XszFEJsUmM0RPSW50LiHTcZZUCldv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.145.0/index.min.mjs": "sha384-ffBshQVeMPRmvhvPDeF6I1Dq88O1ASmmjv+XszFEJsUmM0RPSW50LiHTcZZUCldv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.145.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ViOFUwFqMAwJ/Q1ZHaCD9QzPzNpqLU2UawX0OgQvXpIxRFtiSlVLWezyMmS/eVK0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.387.0/index.min.mjs": "sha384-ViOFUwFqMAwJ/Q1ZHaCD9QzPzNpqLU2UawX0OgQvXpIxRFtiSlVLWezyMmS/eVK0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.387.0/LICENSE
```

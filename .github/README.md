...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.223.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.223.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5n1caNf/t2Zur5HK1ojkaENjGZQYXJSV5Rf02lYQ/SRTUED0aC/PZKrJasrBCZhQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.223.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.223.0/index.min.mjs": "sha384-5n1caNf/t2Zur5HK1ojkaENjGZQYXJSV5Rf02lYQ/SRTUED0aC/PZKrJasrBCZhQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.223.0/LICENSE
```

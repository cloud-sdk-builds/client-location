...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.425.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.425.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+uj/J0yVdv1qMN9ZhXJhhPL5QyMxZ/W/8m6eCegM8E17nkZUcbmc/H2dq7GRFP0u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.425.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.425.0/index.min.mjs": "sha384-+uj/J0yVdv1qMN9ZhXJhhPL5QyMxZ/W/8m6eCegM8E17nkZUcbmc/H2dq7GRFP0u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.425.0/LICENSE
```

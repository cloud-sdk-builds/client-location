...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1012.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1012.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0ocZ1utCMe6+0L/dkkhZFY3smdZBKRL+kCMYNcwDxh23Mxhvy8nLlz3K28r1ctGj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1012.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1012.0/index.min.mjs": "sha384-0ocZ1utCMe6+0L/dkkhZFY3smdZBKRL+kCMYNcwDxh23Mxhvy8nLlz3K28r1ctGj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1012.0/LICENSE
```

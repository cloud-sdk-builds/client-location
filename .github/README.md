...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V0+NbSqSY1sBAbH47MSReFn5qTvZqctiUntZUbBtIU+XH9yEtIpjCXcAN6jt8RiS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.79.0/index.min.mjs": "sha384-V0+NbSqSY1sBAbH47MSReFn5qTvZqctiUntZUbBtIU+XH9yEtIpjCXcAN6jt8RiS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.79.0/LICENSE
```

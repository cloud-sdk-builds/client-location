...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.13.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.13.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-OU8Eq/2SLwQdJAoPamAod6QM/GlkNM5i8AKyhqbaMIcWQpOF/lH023tu4kvYY8Vx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.13.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.13.1/index.min.mjs": "sha384-OU8Eq/2SLwQdJAoPamAod6QM/GlkNM5i8AKyhqbaMIcWQpOF/lH023tu4kvYY8Vx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.13.1/LICENSE
```

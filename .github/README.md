...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.286.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.286.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Yc7YAFAxtKZWE4mx0XnyFezcjqKVmUTUB9zJMPKcZMGOlfEQ1tS6k2qrwS/Zwyv8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.286.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.286.0/index.min.mjs": "sha384-Yc7YAFAxtKZWE4mx0XnyFezcjqKVmUTUB9zJMPKcZMGOlfEQ1tS6k2qrwS/Zwyv8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.286.0/LICENSE
```

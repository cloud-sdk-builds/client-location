...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GBpTmuKaEmBR5hsImeyghU09PyLqmb0ViA/X6An9sJMJAKuYee/pGWGnSGvB+CU9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.470.0/index.min.mjs": "sha384-GBpTmuKaEmBR5hsImeyghU09PyLqmb0ViA/X6An9sJMJAKuYee/pGWGnSGvB+CU9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.470.0/LICENSE
```

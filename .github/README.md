...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tf2y9IlUzPMDRAUcRSeoN2k3OTfvyApAnz7cK4vc+bMwcuSf9RT+6eExv6GEadfL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.473.0/index.min.mjs": "sha384-tf2y9IlUzPMDRAUcRSeoN2k3OTfvyApAnz7cK4vc+bMwcuSf9RT+6eExv6GEadfL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.473.0/LICENSE
```

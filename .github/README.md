...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.418.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.418.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5cjP0TQ3Dc9ds1ebwSu4g1Bk2a79ds1hB3++6p+FcokDzDUjKPoVhvOweoK42821
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.418.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.418.0/index.min.mjs": "sha384-5cjP0TQ3Dc9ds1ebwSu4g1Bk2a79ds1hB3++6p+FcokDzDUjKPoVhvOweoK42821"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.418.0/LICENSE
```

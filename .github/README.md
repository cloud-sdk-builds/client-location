...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-/aEh06LyYSLDaVqnOP4egfgrwLrdkXxaQQI92BXiRRBgWwQINjX59u+Bmg82p6Af
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.379.1/index.min.mjs": "sha384-/aEh06LyYSLDaVqnOP4egfgrwLrdkXxaQQI92BXiRRBgWwQINjX59u+Bmg82p6Af"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.379.1/LICENSE
```

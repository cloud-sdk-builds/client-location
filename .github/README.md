...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.485.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.485.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G1awmvWWInXTQRiv75xm17c+If8Sp+HwSLPVJzzvsrL5WpZZPoFZswWy+hfybxEv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.485.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.485.0/index.min.mjs": "sha384-G1awmvWWInXTQRiv75xm17c+If8Sp+HwSLPVJzzvsrL5WpZZPoFZswWy+hfybxEv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.485.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4iM9W0q5K2tr0AzkZ4NNvEE7MgD2DT6aLBwipYz4lbyV177TYB5ocqmUfzZDHwAc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.709.0/index.min.mjs": "sha384-4iM9W0q5K2tr0AzkZ4NNvEE7MgD2DT6aLBwipYz4lbyV177TYB5ocqmUfzZDHwAc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.709.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mbvsMpWaxYHIv3uLGfL1z6cs7XPN4GAWnOs4FC7UJs6EGlv0ynTcHOoqJUHLgZUu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.82.0/index.min.mjs": "sha384-mbvsMpWaxYHIv3uLGfL1z6cs7XPN4GAWnOs4FC7UJs6EGlv0ynTcHOoqJUHLgZUu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.82.0/LICENSE
```

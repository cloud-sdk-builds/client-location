...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LqON4jbR0x1fCkbtmo/T3LxgQPcSWHH3zxb5nGi9H7ELLvkXhfMhaVxo4xWGsOYz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.501.0/index.min.mjs": "sha384-LqON4jbR0x1fCkbtmo/T3LxgQPcSWHH3zxb5nGi9H7ELLvkXhfMhaVxo4xWGsOYz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.501.0/LICENSE
```

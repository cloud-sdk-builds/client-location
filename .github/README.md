...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.840.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.840.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JBy9uacXdW+tJatV42PGhJXVuj1KQinVg08CbtwBydtkq5mL28UbdM+83YLHUwjC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.840.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.840.0/index.min.mjs": "sha384-JBy9uacXdW+tJatV42PGhJXVuj1KQinVg08CbtwBydtkq5mL28UbdM+83YLHUwjC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.840.0/LICENSE
```

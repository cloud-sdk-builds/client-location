...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UrjqeeesSLtk4zrm7ANq8unIvy/Doc415pnXn6ADq1fuvloPbhWcQUlf/P/W5YBj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.968.0/index.min.mjs": "sha384-UrjqeeesSLtk4zrm7ANq8unIvy/Doc415pnXn6ADq1fuvloPbhWcQUlf/P/W5YBj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.968.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3mmi8bEGKXgGFhpaL5grbiZfUN6pq6cRlzO4jBJSLTuzZcVh3reYi13PC8Ub5e9d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.886.0/index.min.mjs": "sha384-3mmi8bEGKXgGFhpaL5grbiZfUN6pq6cRlzO4jBJSLTuzZcVh3reYi13PC8Ub5e9d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.886.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6bi7m62KPvATxnR3oj0V3sP5wRMY2CLeaMyqi4V8V++JQOb7sHb8YHUMiIxpopIX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.957.0/index.min.mjs": "sha384-6bi7m62KPvATxnR3oj0V3sP5wRMY2CLeaMyqi4V8V++JQOb7sHb8YHUMiIxpopIX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.957.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3TgSDMOebvMMKLgPpRA6nXZNUVf6S+7BS0udeOW2mK0huQk3uX98QuF0+Ma03SH3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.918.0/index.min.mjs": "sha384-3TgSDMOebvMMKLgPpRA6nXZNUVf6S+7BS0udeOW2mK0huQk3uX98QuF0+Ma03SH3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.918.0/LICENSE
```

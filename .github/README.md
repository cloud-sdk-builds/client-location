...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3v6x3j5S5zkMCeGYQAdMt5q5y3sjKnZAyDiRF9VukTGnpj3CAdYQa3ITbnIKucIu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.118.0/index.min.mjs": "sha384-3v6x3j5S5zkMCeGYQAdMt5q5y3sjKnZAyDiRF9VukTGnpj3CAdYQa3ITbnIKucIu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.118.0/LICENSE
```

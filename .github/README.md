...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0FLWNcC3q5uku239EzoTkV4ftkurjZ1gljwOQAQOSIk+pw1cGiLrcspHMcGXmF8P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.996.0/index.min.mjs": "sha384-0FLWNcC3q5uku239EzoTkV4ftkurjZ1gljwOQAQOSIk+pw1cGiLrcspHMcGXmF8P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.996.0/LICENSE
```

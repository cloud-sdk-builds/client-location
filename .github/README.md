...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1028.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1028.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1EGjtHPxpawv9j5KkuXoNPEWZqZ7BPplQcjikx0/bXNk8T4tL6dWN61soinbdBNV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1028.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1028.0/index.min.mjs": "sha384-1EGjtHPxpawv9j5KkuXoNPEWZqZ7BPplQcjikx0/bXNk8T4tL6dWN61soinbdBNV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1028.0/LICENSE
```

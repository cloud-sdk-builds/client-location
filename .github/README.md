...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gBZgSlu1YU03J9+USexc3aw5+OqBWGux+kAVgSZ7m1drvvq0CcdIUTMA84ufuggq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.932.0/index.min.mjs": "sha384-gBZgSlu1YU03J9+USexc3aw5+OqBWGux+kAVgSZ7m1drvvq0CcdIUTMA84ufuggq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.932.0/LICENSE
```

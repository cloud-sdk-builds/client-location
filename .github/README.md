...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cOnvHjf2cgIzAWzVtGaxJxDuEbpi5t0DPX9hv18Af5iqiimyANJLXGd/tUvivP1I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.699.0/index.min.mjs": "sha384-cOnvHjf2cgIzAWzVtGaxJxDuEbpi5t0DPX9hv18Af5iqiimyANJLXGd/tUvivP1I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.699.0/LICENSE
```

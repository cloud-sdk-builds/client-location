...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9wP1g/vXLq8ABwP7hC91/nvJv6hGBgiMXv5GKYioJzogz3V5pjeAhw7I5rEscteF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.845.0/index.min.mjs": "sha384-9wP1g/vXLq8ABwP7hC91/nvJv6hGBgiMXv5GKYioJzogz3V5pjeAhw7I5rEscteF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.845.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jh+uBeciMTJcGPw8P/GP6Zul2VhEl+q8+ii/IfdzPULUXBVhcBetK3Bsb2+VTBCo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.914.0/index.min.mjs": "sha384-jh+uBeciMTJcGPw8P/GP6Zul2VhEl+q8+ii/IfdzPULUXBVhcBetK3Bsb2+VTBCo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.914.0/LICENSE
```

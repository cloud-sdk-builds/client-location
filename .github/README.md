...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LuzsIgl8jGGtBtoF95+SwGtT1V8Luuc9+McOzlbIZuYPJo49/iuDU9VIRmcfvHHy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.514.0/index.min.mjs": "sha384-LuzsIgl8jGGtBtoF95+SwGtT1V8Luuc9+McOzlbIZuYPJo49/iuDU9VIRmcfvHHy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.514.0/LICENSE
```

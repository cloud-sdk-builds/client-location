...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qCe34P0s3KHGS78vJ1MeWnIzthdbynfMd/RNMyF7w8f2AhWpl1za5gfUSkEMkdX4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.940.0/index.min.mjs": "sha384-qCe34P0s3KHGS78vJ1MeWnIzthdbynfMd/RNMyF7w8f2AhWpl1za5gfUSkEMkdX4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.940.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.614.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.614.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fojt2vIe3oJ+RrZl+z+F8Yit6MSWgl79LlFh4BNLtBzdOpH2Aq32ySDN2wPmssj3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.614.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.614.0/index.min.mjs": "sha384-fojt2vIe3oJ+RrZl+z+F8Yit6MSWgl79LlFh4BNLtBzdOpH2Aq32ySDN2wPmssj3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.614.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.34.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.34.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uwMQ0MlOepFZo5wegSvrOpkd1a0APb/D6V66KLUje+96hI3hILHE5aIOVcDt88iZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.34.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.34.0/index.min.mjs": "sha384-uwMQ0MlOepFZo5wegSvrOpkd1a0APb/D6V66KLUje+96hI3hILHE5aIOVcDt88iZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.34.0/LICENSE
```

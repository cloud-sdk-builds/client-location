...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MzFakxkS/Ks3e2zt85O8HXfC5J8tsPNImZ+KEMGv0ZdgBSPGotFVOfnvqKEvxfQq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.666.0/index.min.mjs": "sha384-MzFakxkS/Ks3e2zt85O8HXfC5J8tsPNImZ+KEMGv0ZdgBSPGotFVOfnvqKEvxfQq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.666.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gHTTSIM1+lpT3n6n7kAU+m+lxkgGcJhFGG8OVaI+gtIL55/BJCRBtAKld6Y3AYmu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.664.0/index.min.mjs": "sha384-gHTTSIM1+lpT3n6n7kAU+m+lxkgGcJhFGG8OVaI+gtIL55/BJCRBtAKld6Y3AYmu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.664.0/LICENSE
```

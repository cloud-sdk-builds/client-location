...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AFY695Ufdm0bM+UcKZyxacddLEgyxnGYwnV2gFpEpv6NZjF8diOJRmXufBJ1TplB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.998.0/index.min.mjs": "sha384-AFY695Ufdm0bM+UcKZyxacddLEgyxnGYwnV2gFpEpv6NZjF8diOJRmXufBJ1TplB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.998.0/LICENSE
```

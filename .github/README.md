...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.424.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.424.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qY6BgEGLd/A4jdvs+y0mlyEVDG4oxBzJnHJNWSNT3YSxZdgt32IuhvvjMVpphNuX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.424.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.424.0/index.min.mjs": "sha384-qY6BgEGLd/A4jdvs+y0mlyEVDG4oxBzJnHJNWSNT3YSxZdgt32IuhvvjMVpphNuX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.424.0/LICENSE
```

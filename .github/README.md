...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yd6ZDjaj9q+V8O3zt+VBsTg4Q8K2VHSJ44vaTd9uKMooB2j/1KA0CwnhTO7UkWqE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.297.0/index.min.mjs": "sha384-yd6ZDjaj9q+V8O3zt+VBsTg4Q8K2VHSJ44vaTd9uKMooB2j/1KA0CwnhTO7UkWqE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.297.0/LICENSE
```

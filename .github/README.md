...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.491.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.491.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lrdyr7ncy19oUVWAQ8agdozTPHA/6ncObb/bLU2LFnfjjWjQQSbkDo7fCNZOo5NB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.491.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.491.0/index.min.mjs": "sha384-lrdyr7ncy19oUVWAQ8agdozTPHA/6ncObb/bLU2LFnfjjWjQQSbkDo7fCNZOo5NB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.491.0/LICENSE
```

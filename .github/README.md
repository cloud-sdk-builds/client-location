...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-baxxatDnHwQg/VMmR0R6BZuf18Zewqm/PUkLQ4Wfl9jQKO3dcRYiTGQ23V62OJpB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.257.0/index.min.mjs": "sha384-baxxatDnHwQg/VMmR0R6BZuf18Zewqm/PUkLQ4Wfl9jQKO3dcRYiTGQ23V62OJpB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.257.0/LICENSE
```

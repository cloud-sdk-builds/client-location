...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1005.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1005.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g+BBSfxV9lLKcS5IB4TZLTsI+n6oFKfS/oJVVuMCnSKEcJLwt8PPjB3e9rJxuz99
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1005.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1005.0/index.min.mjs": "sha384-g+BBSfxV9lLKcS5IB4TZLTsI+n6oFKfS/oJVVuMCnSKEcJLwt8PPjB3e9rJxuz99"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1005.0/LICENSE
```

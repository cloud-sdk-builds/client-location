...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+KJxKxzd7Jh9Ul5x3yWci7xDaMCt8z/SI38mhxaUQnIU0tGAhcTopL9RdgfLsl3Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.816.0/index.min.mjs": "sha384-+KJxKxzd7Jh9Ul5x3yWci7xDaMCt8z/SI38mhxaUQnIU0tGAhcTopL9RdgfLsl3Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.816.0/LICENSE
```

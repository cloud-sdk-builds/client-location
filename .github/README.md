...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1019.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1019.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AxeorbbsHu2qRFFS5Gwilkth9uPYXQc29npv04WVa00GmOXfUiJ3XGMqs0CI6nm7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1019.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1019.0/index.min.mjs": "sha384-AxeorbbsHu2qRFFS5Gwilkth9uPYXQc29npv04WVa00GmOXfUiJ3XGMqs0CI6nm7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1019.0/LICENSE
```

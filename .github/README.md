...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NLShAnUSdLU6Q0i5yby+lx0IiHSJILtcwoauAgUMvZ+GbJd2QOyIQ4mos7JQmyWN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.523.0/index.min.mjs": "sha384-NLShAnUSdLU6Q0i5yby+lx0IiHSJILtcwoauAgUMvZ+GbJd2QOyIQ4mos7JQmyWN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.523.0/LICENSE
```

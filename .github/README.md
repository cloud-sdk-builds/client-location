...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7gd7LdYx7GlpHoV3Q4R6DZ+YyYoc72Ct9j7FkeIeKTqV0OYEW8lXaWR/MYwRsbRe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.127.0/index.min.mjs": "sha384-7gd7LdYx7GlpHoV3Q4R6DZ+YyYoc72Ct9j7FkeIeKTqV0OYEW8lXaWR/MYwRsbRe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.127.0/LICENSE
```

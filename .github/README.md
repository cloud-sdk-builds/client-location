...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.238.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.238.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MEhOULqA62eTSbsfMiMO9eJjEnii0WhlO0tsDkevaWN0kOupHU4LC/OQx5dVRSht
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.238.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.238.0/index.min.mjs": "sha384-MEhOULqA62eTSbsfMiMO9eJjEnii0WhlO0tsDkevaWN0kOupHU4LC/OQx5dVRSht"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.238.0/LICENSE
```

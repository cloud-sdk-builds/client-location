...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.256.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-19Lb0smd4zwUvLvaJBDyqVczC3BVxrHmEHULNrjfY256WOGP3HKZnWh3wkYv2yau
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.256.0/index.min.mjs": "sha384-19Lb0smd4zwUvLvaJBDyqVczC3BVxrHmEHULNrjfY256WOGP3HKZnWh3wkYv2yau"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.256.0/LICENSE
```

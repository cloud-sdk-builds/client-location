...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O+VIUfIoyDkYPoN+4Nyqn3ZKoV18U4QQRWCsRoOJE//geJWDkRFoeObMOoeRMV3F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.662.0/index.min.mjs": "sha384-O+VIUfIoyDkYPoN+4Nyqn3ZKoV18U4QQRWCsRoOJE//geJWDkRFoeObMOoeRMV3F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.662.0/LICENSE
```

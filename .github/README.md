...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.620.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.620.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/DVMjaORb3ak5UNnVPofpxZcRoWadbr5uNprFjrIjhgZN7lPGueLN+YjmD7TPNnx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.620.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.620.0/index.min.mjs": "sha384-/DVMjaORb3ak5UNnVPofpxZcRoWadbr5uNprFjrIjhgZN7lPGueLN+YjmD7TPNnx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.620.0/LICENSE
```

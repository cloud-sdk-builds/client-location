...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O+bJ8Zf9W00Bmsgz8IjNGDVQCXI5la7hWbiXdX1aKzCrSaKNOGyb8wbNfamw6igV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.609.0/index.min.mjs": "sha384-O+bJ8Zf9W00Bmsgz8IjNGDVQCXI5la7hWbiXdX1aKzCrSaKNOGyb8wbNfamw6igV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.609.0/LICENSE
```

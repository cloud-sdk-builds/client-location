...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ugpJGq5Lm05vu7DTVmabdlHC3ZhGwU0PnsEibqRsyMl9q3lJtSUH8Z7CmLSSCj7S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.271.0/index.min.mjs": "sha384-ugpJGq5Lm05vu7DTVmabdlHC3ZhGwU0PnsEibqRsyMl9q3lJtSUH8Z7CmLSSCj7S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.271.0/LICENSE
```

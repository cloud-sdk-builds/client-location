...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1031.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1031.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lGZmcXrkxCdqZYSXlJUjm7Kb0qFPfI9FLu0cmQ3iSIuKMQjT8e8rO973Tf46GOWH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1031.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1031.0/index.min.mjs": "sha384-lGZmcXrkxCdqZYSXlJUjm7Kb0qFPfI9FLu0cmQ3iSIuKMQjT8e8rO973Tf46GOWH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1031.0/LICENSE
```

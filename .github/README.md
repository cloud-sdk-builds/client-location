...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.45.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.45.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hXROB5FDgx+iXrXSw0wG67uUt5q8gv6oD62L++xy9IIfz102RcxnnDYr6aKIygS9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.45.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.45.0/index.min.mjs": "sha384-hXROB5FDgx+iXrXSw0wG67uUt5q8gv6oD62L++xy9IIfz102RcxnnDYr6aKIygS9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.45.0/LICENSE
```

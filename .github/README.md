...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AEFTN4S4l+OvRiJ4cPaPCiNoWDBCip0BQboCoa3oHpwIFZTLELCQrsQYiN/QO/fq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.168.0/index.min.mjs": "sha384-AEFTN4S4l+OvRiJ4cPaPCiNoWDBCip0BQboCoa3oHpwIFZTLELCQrsQYiN/QO/fq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.168.0/LICENSE
```

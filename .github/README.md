...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.183.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.183.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WTGD/jEoqoq6I3JB9U2VXrgFkOrDlgvaG1y4xtc5R91vg13fgkOcAo4e5VeYe0u7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.183.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.183.0/index.min.mjs": "sha384-WTGD/jEoqoq6I3JB9U2VXrgFkOrDlgvaG1y4xtc5R91vg13fgkOcAo4e5VeYe0u7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.183.0/LICENSE
```

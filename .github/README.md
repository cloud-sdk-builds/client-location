...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JEbp9FRyIedG1ykLzfkH2JkxaS2txGk0HLu1g1FLGjmqZCg3jXnVFJVBi482puqk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.583.0/index.min.mjs": "sha384-JEbp9FRyIedG1ykLzfkH2JkxaS2txGk0HLu1g1FLGjmqZCg3jXnVFJVBi482puqk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.583.0/LICENSE
```

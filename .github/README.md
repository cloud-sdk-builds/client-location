...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.821.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.821.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7DYtcmOYRPZWXpeWXDKNHqh5dySPIG4If0ZVDrids/k8/p99JWdyp8R7YuDHSs4p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.821.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.821.0/index.min.mjs": "sha384-7DYtcmOYRPZWXpeWXDKNHqh5dySPIG4If0ZVDrids/k8/p99JWdyp8R7YuDHSs4p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.821.0/LICENSE
```

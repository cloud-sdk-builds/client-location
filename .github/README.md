...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZMvaiQxtIX+P5JG0T5pLbRjSAeK9t7fSzOeHNxyIZiYeH/HCoVNAVKPmv/zQfAgL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.887.0/index.min.mjs": "sha384-ZMvaiQxtIX+P5JG0T5pLbRjSAeK9t7fSzOeHNxyIZiYeH/HCoVNAVKPmv/zQfAgL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.887.0/LICENSE
```

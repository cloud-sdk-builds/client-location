...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UiCdBXCdVe5XoRdSXnWQ59BvCLvR3MhiEKb6RjfCR3EfL1f4lrBxZCiWEj17vn5V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.872.0/index.min.mjs": "sha384-UiCdBXCdVe5XoRdSXnWQ59BvCLvR3MhiEKb6RjfCR3EfL1f4lrBxZCiWEj17vn5V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.872.0/LICENSE
```

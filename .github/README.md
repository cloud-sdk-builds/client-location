...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.405.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.405.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mebZcxlhK5tKZpWlYAsnpWw2yP0wvT1VmTsl9TSFRuiPKK5RBxe33EMtPZHrY7Jo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.405.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.405.0/index.min.mjs": "sha384-mebZcxlhK5tKZpWlYAsnpWw2yP0wvT1VmTsl9TSFRuiPKK5RBxe33EMtPZHrY7Jo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.405.0/LICENSE
```

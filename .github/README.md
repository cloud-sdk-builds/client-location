...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ybS3Ss9me1A9+6DfXIkERtMs7Hl5AuO2wyGhsXdaW9tSGEb+6MIGQcxRDSBlUWEf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.965.0/index.min.mjs": "sha384-ybS3Ss9me1A9+6DfXIkERtMs7Hl5AuO2wyGhsXdaW9tSGEb+6MIGQcxRDSBlUWEf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.965.0/LICENSE
```

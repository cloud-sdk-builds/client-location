...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vBuagNTgjqYkeefj8m3Kwu5D4CjbkfKqAvV2759ybk/XfelM+lQSDGSeHdWwYOC5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.567.0/index.min.mjs": "sha384-vBuagNTgjqYkeefj8m3Kwu5D4CjbkfKqAvV2759ybk/XfelM+lQSDGSeHdWwYOC5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.567.0/LICENSE
```

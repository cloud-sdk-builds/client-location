...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1038.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1038.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KN1ZedO2Xqxx8OtrGfA5P1B2WC/SDlbjqto6JPCNJD4Y7LU0STScHIw7tjtkbTX1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1038.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1038.0/index.min.mjs": "sha384-KN1ZedO2Xqxx8OtrGfA5P1B2WC/SDlbjqto6JPCNJD4Y7LU0STScHIw7tjtkbTX1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1038.0/LICENSE
```

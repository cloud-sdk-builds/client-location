...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Isl5FzMK+r+lAYGwIunrUjxAXtrEoBbDQrs8z+D+mbl9HhMH7RayieOq8bTb/52v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.298.0/index.min.mjs": "sha384-Isl5FzMK+r+lAYGwIunrUjxAXtrEoBbDQrs8z+D+mbl9HhMH7RayieOq8bTb/52v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.298.0/LICENSE
```

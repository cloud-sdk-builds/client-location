...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8ljNo/92MfZet/kZsNLadXosl5Qt/2+2nB692BeH3zIgzn678+dN7iazJNMJj2sJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.49.0/index.min.mjs": "sha384-8ljNo/92MfZet/kZsNLadXosl5Qt/2+2nB692BeH3zIgzn678+dN7iazJNMJj2sJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.49.0/LICENSE
```

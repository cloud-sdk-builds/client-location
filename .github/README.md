...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Tb71kZ7ONrdtbnji/ajuMlLAN7YWRDmXNfnFlqViCoPiYxu2/v6vWMzj7oiF0ZrH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.895.0/index.min.mjs": "sha384-Tb71kZ7ONrdtbnji/ajuMlLAN7YWRDmXNfnFlqViCoPiYxu2/v6vWMzj7oiF0ZrH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.895.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N9ATmWEs4H4FzdWHUK4ekckKFVcgy9B888lpFUBvrsLkcgbg8jfg6JAh+NfbuRnK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.993.0/index.min.mjs": "sha384-N9ATmWEs4H4FzdWHUK4ekckKFVcgy9B888lpFUBvrsLkcgbg8jfg6JAh+NfbuRnK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.993.0/LICENSE
```

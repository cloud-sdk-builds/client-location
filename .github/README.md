...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1037.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1037.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qs8TcLdvFZ6JX7pgoYc2IQjMZ2GwAPzVU6AFrauEwdbslt5ywLpVJqkeATLkowHX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1037.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1037.0/index.min.mjs": "sha384-qs8TcLdvFZ6JX7pgoYc2IQjMZ2GwAPzVU6AFrauEwdbslt5ywLpVJqkeATLkowHX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1037.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.568.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.568.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B8/1qx3RppzS65aP1GqRiiVTvsiWmI8wdtjr9NTZTZ18HRUW4et7yOAvGTkqsGIo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.568.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.568.0/index.min.mjs": "sha384-B8/1qx3RppzS65aP1GqRiiVTvsiWmI8wdtjr9NTZTZ18HRUW4et7yOAvGTkqsGIo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.568.0/LICENSE
```

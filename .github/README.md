...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ztz7/KgyuFkMXFblnLgAfBRDo8tabZyjzQxJvRIUOKyyt2w4IZQ+o/eMsC2YoE0/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.454.0/index.min.mjs": "sha384-ztz7/KgyuFkMXFblnLgAfBRDo8tabZyjzQxJvRIUOKyyt2w4IZQ+o/eMsC2YoE0/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.454.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ShU/qzb0/tAzAwEFj1ts/A/0WexUanF778h9uJZSRn7qr3nUJdgJq6mjYZ4ZKfwe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.338.0/index.min.mjs": "sha384-ShU/qzb0/tAzAwEFj1ts/A/0WexUanF778h9uJZSRn7qr3nUJdgJq6mjYZ4ZKfwe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.338.0/LICENSE
```

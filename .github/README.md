...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ObOh4A9lPbdF4rQmKP+J09uOVcm+cpOZbQwmOOhEgfLKKvy+tO4TyQ8eeE1VpMTK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.948.0/index.min.mjs": "sha384-ObOh4A9lPbdF4rQmKP+J09uOVcm+cpOZbQwmOOhEgfLKKvy+tO4TyQ8eeE1VpMTK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.948.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QUZlE+xRDaKvGBIuXkZFEdJKrZ0GNBgXM9tK1KPy+Uld7ciJwicz3TkFuYFR1GcO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.410.0/index.min.mjs": "sha384-QUZlE+xRDaKvGBIuXkZFEdJKrZ0GNBgXM9tK1KPy+Uld7ciJwicz3TkFuYFR1GcO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.410.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1040.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1040.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+xl4zppP3mijsMynR7C2/IPJ67+6PjPTB+d1Vu/V6NSxV6SF6OoVWFfhunZc/a3z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1040.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1040.0/index.min.mjs": "sha384-+xl4zppP3mijsMynR7C2/IPJ67+6PjPTB+d1Vu/V6NSxV6SF6OoVWFfhunZc/a3z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1040.0/LICENSE
```

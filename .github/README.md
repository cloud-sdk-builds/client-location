...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cZMoj2y5s4PyvgtXvX8zp3MdC6Eu5ZQzhya/g+jMTD3GpBoxbjjNWgEHmHGrJL+R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.409.0/index.min.mjs": "sha384-cZMoj2y5s4PyvgtXvX8zp3MdC6Eu5ZQzhya/g+jMTD3GpBoxbjjNWgEHmHGrJL+R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.409.0/LICENSE
```

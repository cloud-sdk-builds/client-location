...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.477.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.477.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C5/yJN3YHwBg3cVGPwmvRlG7qEcASm/bHY/d8b+TbomZ2RKgQXwtxQ+0XonnUO3U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.477.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.477.0/index.min.mjs": "sha384-C5/yJN3YHwBg3cVGPwmvRlG7qEcASm/bHY/d8b+TbomZ2RKgQXwtxQ+0XonnUO3U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.477.0/LICENSE
```

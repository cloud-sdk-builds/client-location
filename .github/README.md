...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-robpGmbduRvM7/LCcMgzEbs+B9bb3PKHXRyYCOebkX+7Htzz+UEUfiw+RNJbB44I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.192.0/index.min.mjs": "sha384-robpGmbduRvM7/LCcMgzEbs+B9bb3PKHXRyYCOebkX+7Htzz+UEUfiw+RNJbB44I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.192.0/LICENSE
```

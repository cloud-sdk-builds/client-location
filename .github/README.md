...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.202.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.202.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Te8CxVSpMiZYG5TmjEsI1Lb1chzOabYqgVhZwZyCnNcgqq/Eza6LDG7fQ1r7WL1R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.202.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.202.0/index.min.mjs": "sha384-Te8CxVSpMiZYG5TmjEsI1Lb1chzOabYqgVhZwZyCnNcgqq/Eza6LDG7fQ1r7WL1R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.202.0/LICENSE
```

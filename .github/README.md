...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.839.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.839.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PuAtG5SYqzYFqph8PWEG3agHjO3Zbsp/Qa0YHgISw2PS4yauQf3wOAu9Q3RPtytU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.839.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.839.0/index.min.mjs": "sha384-PuAtG5SYqzYFqph8PWEG3agHjO3Zbsp/Qa0YHgISw2PS4yauQf3wOAu9Q3RPtytU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.839.0/LICENSE
```

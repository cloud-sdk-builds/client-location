...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.481.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.481.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M8B4Pq1x/sX5GtgzhlGop8DQUBkT0Pd7gi6VvQ2KulpY55OY2XI5jRHcbwMhA3CH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.481.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.481.0/index.min.mjs": "sha384-M8B4Pq1x/sX5GtgzhlGop8DQUBkT0Pd7gi6VvQ2KulpY55OY2XI5jRHcbwMhA3CH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.481.0/LICENSE
```

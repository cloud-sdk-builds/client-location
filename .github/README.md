...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KiAMnAGjjiy3uFv5CewPAxGD2NKEfEMMAYXCs+Mu+ksQcRRPkK6tGGj5oIfNSOXz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.445.0/index.min.mjs": "sha384-KiAMnAGjjiy3uFv5CewPAxGD2NKEfEMMAYXCs+Mu+ksQcRRPkK6tGGj5oIfNSOXz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.445.0/LICENSE
```

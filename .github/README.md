...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-D0VZQL+ZchpIK9n+c+Qnmnh/bPd9OYYW8ZHTFu1/RaouAO7qyGNAMzB7EuygJTWy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.962.0/index.min.mjs": "sha384-D0VZQL+ZchpIK9n+c+Qnmnh/bPd9OYYW8ZHTFu1/RaouAO7qyGNAMzB7EuygJTWy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.962.0/LICENSE
```

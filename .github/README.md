...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0L9YoSqY7b3Hi5V0WBn+rwplBzDaDayHDsyiKeLYTjOnHhd5xpjh9nmPGBA8R77D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.131.0/index.min.mjs": "sha384-0L9YoSqY7b3Hi5V0WBn+rwplBzDaDayHDsyiKeLYTjOnHhd5xpjh9nmPGBA8R77D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.131.0/LICENSE
```

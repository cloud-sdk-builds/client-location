...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1025.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1025.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8pU1TVSroKu4ocuAihZVzGcj5MNBQyphias+THO+++aADhwOm+496WS6mG4zxT8u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1025.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1025.0/index.min.mjs": "sha384-8pU1TVSroKu4ocuAihZVzGcj5MNBQyphias+THO+++aADhwOm+496WS6mG4zxT8u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1025.0/LICENSE
```

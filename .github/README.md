...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.198.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.198.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pjsDqbjktGqaLs7EujE6MNwALtbwD23K1lCYfFlx+O25RUAzsr/5Zp0VM6G4ho6T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.198.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.198.0/index.min.mjs": "sha384-pjsDqbjktGqaLs7EujE6MNwALtbwD23K1lCYfFlx+O25RUAzsr/5Zp0VM6G4ho6T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.198.0/LICENSE
```

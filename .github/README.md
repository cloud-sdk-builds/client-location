...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UdATb697EaIGVlCgyYw6A8UiCtDXsJaAMgYXzlqc2gR5SosW/a6DnRWvwNkdFRFk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.972.0/index.min.mjs": "sha384-UdATb697EaIGVlCgyYw6A8UiCtDXsJaAMgYXzlqc2gR5SosW/a6DnRWvwNkdFRFk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.972.0/LICENSE
```

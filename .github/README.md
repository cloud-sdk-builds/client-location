...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yN8CKRVj3sOsCCDpOdN+A6Bu/LaZzk8qIUetP9lbAhbCchJ57pbBTRxG5gsi4t5P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.622.0/index.min.mjs": "sha384-yN8CKRVj3sOsCCDpOdN+A6Bu/LaZzk8qIUetP9lbAhbCchJ57pbBTRxG5gsi4t5P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.622.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NDeH5r1waqZA3hHoiHspqUiXB4WLbTNb1EzoXm7ZMCYxTi/01W3zY45mI85YJt+k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.989.0/index.min.mjs": "sha384-NDeH5r1waqZA3hHoiHspqUiXB4WLbTNb1EzoXm7ZMCYxTi/01W3zY45mI85YJt+k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.989.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.752.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.752.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L9dKoieawpyQU4Ed+X/o1ORxzV7ncKPdMKPPUMClbIiaoM9qgpFdGb2gvsURoVQB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.752.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.752.0/index.min.mjs": "sha384-L9dKoieawpyQU4Ed+X/o1ORxzV7ncKPdMKPPUMClbIiaoM9qgpFdGb2gvsURoVQB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.752.0/LICENSE
```

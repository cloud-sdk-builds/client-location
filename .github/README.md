...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J/NY1U61KYbvmKroqEWawvJRCN/choiaEZ8YlkfX6Ms4FcPN/V6H6b5JqgcoDCZE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.613.0/index.min.mjs": "sha384-J/NY1U61KYbvmKroqEWawvJRCN/choiaEZ8YlkfX6Ms4FcPN/V6H6b5JqgcoDCZE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.613.0/LICENSE
```

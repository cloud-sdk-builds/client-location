...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-saj+gwS1Ohx+kppA7FFqnVYxUwc6nx7XK5kfulOE775uQ3SmvAVbI2ketwgWfXKQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.267.0/index.min.mjs": "sha384-saj+gwS1Ohx+kppA7FFqnVYxUwc6nx7XK5kfulOE775uQ3SmvAVbI2ketwgWfXKQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.267.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.600.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.600.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-derKWo1q8H63QhwuGfdXJI+XAh/V0lNcC7wxiInrmMFxTQDYwUhnpSrNfSmcejm7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.600.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.600.0/index.min.mjs": "sha384-derKWo1q8H63QhwuGfdXJI+XAh/V0lNcC7wxiInrmMFxTQDYwUhnpSrNfSmcejm7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.600.0/LICENSE
```

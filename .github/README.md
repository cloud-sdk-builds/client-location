...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.803.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.803.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5BlgR6G6B/YHHRh1uSBeNe5IUKy4RNFEyiYBAadXctIOxx9Xdm2F9DBjKq9xDvq7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.803.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.803.0/index.min.mjs": "sha384-5BlgR6G6B/YHHRh1uSBeNe5IUKy4RNFEyiYBAadXctIOxx9Xdm2F9DBjKq9xDvq7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.803.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VR56iohJeCOu+kLlHHEs4PvyhvB1V4HKerz2d5GxCUqCSgtWpIHdOK4lWUFGytaa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.226.0/index.min.mjs": "sha384-VR56iohJeCOu+kLlHHEs4PvyhvB1V4HKerz2d5GxCUqCSgtWpIHdOK4lWUFGytaa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.226.0/LICENSE
```

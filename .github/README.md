...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.146.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.146.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cg+H+oKWS6VQ62G2mtI+upSEbi6I8i58mK0b6bFdw1poeGhAtQ9Y2TblqIizux2J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.146.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.146.0/index.min.mjs": "sha384-cg+H+oKWS6VQ62G2mtI+upSEbi6I8i58mK0b6bFdw1poeGhAtQ9Y2TblqIizux2J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.146.0/LICENSE
```

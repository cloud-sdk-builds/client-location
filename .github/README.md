...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.436.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.436.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a+p2U38sm6WabLC9LDUo4h4RP9FUKORd8NL7/Dcysw5d3xF/5Is5s8F4qNPkFxMB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.436.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.436.0/index.min.mjs": "sha384-a+p2U38sm6WabLC9LDUo4h4RP9FUKORd8NL7/Dcysw5d3xF/5Is5s8F4qNPkFxMB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.436.0/LICENSE
```

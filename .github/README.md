...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F940bK+6jcLjtsrLLUNVTS2YtKOIvGGejSTNc3aC3dYUlzYNj5HzPpnQf7f9nhIg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.58.0/index.min.mjs": "sha384-F940bK+6jcLjtsrLLUNVTS2YtKOIvGGejSTNc3aC3dYUlzYNj5HzPpnQf7f9nhIg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.58.0/LICENSE
```

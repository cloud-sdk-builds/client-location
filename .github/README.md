...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qAYSjFc3OR9qaJGJVbUrkuzeot/jhIvv9zDhWuVzsThEhwbkKDDxM0Tfzn+lqX6o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.142.0/index.min.mjs": "sha384-qAYSjFc3OR9qaJGJVbUrkuzeot/jhIvv9zDhWuVzsThEhwbkKDDxM0Tfzn+lqX6o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.142.0/LICENSE
```

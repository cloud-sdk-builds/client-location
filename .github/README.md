...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.465.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.465.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zIHyJrswrtp77aIe9fa3x/LS7Pgt/Ubp+BYFEd/wYyDVAt47hRAkXFmMpndbBXVx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.465.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.465.0/index.min.mjs": "sha384-zIHyJrswrtp77aIe9fa3x/LS7Pgt/Ubp+BYFEd/wYyDVAt47hRAkXFmMpndbBXVx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.465.0/LICENSE
```

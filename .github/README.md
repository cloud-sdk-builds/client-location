...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q3QTYmIwWnC7ElYbgJWFosdoQAkCyIX0jD/KNhe2usXe+TzksKlKp7Nyx0eIxxw8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.328.0/index.min.mjs": "sha384-q3QTYmIwWnC7ElYbgJWFosdoQAkCyIX0jD/KNhe2usXe+TzksKlKp7Nyx0eIxxw8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.328.0/LICENSE
```

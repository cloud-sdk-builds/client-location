...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UoGoVQ147vXTcgc9gSjCioh3tJl6c6x/tTYDpYbnCpAKjRoQ9XUQ+ESqKv5X1bAQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.730.0/index.min.mjs": "sha384-UoGoVQ147vXTcgc9gSjCioh3tJl6c6x/tTYDpYbnCpAKjRoQ9XUQ+ESqKv5X1bAQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.730.0/LICENSE
```

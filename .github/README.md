...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zs9La3VgVnhx+SpxaMXl76qRvqEkqsmxe3MwQIOPNMWdEIvU9hVT+zUvCWCzsfos
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.896.0/index.min.mjs": "sha384-Zs9La3VgVnhx+SpxaMXl76qRvqEkqsmxe3MwQIOPNMWdEIvU9hVT+zUvCWCzsfos"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.896.0/LICENSE
```

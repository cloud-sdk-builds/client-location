...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MXBsQDP82erL6E25PVSphklHl++am2ttnkbmkxXZ9k6tdjTdzaMTGR2+kHtiCYdW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.616.0/index.min.mjs": "sha384-MXBsQDP82erL6E25PVSphklHl++am2ttnkbmkxXZ9k6tdjTdzaMTGR2+kHtiCYdW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.616.0/LICENSE
```

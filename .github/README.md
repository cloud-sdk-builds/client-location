...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.248.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.248.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LSALo8Ad6PNqSqInVgOAWVLkvhznzqoy6W3G8MtE7er5gSm8yF6hBec7jPOyh8Ft
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.248.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.248.0/index.min.mjs": "sha384-LSALo8Ad6PNqSqInVgOAWVLkvhznzqoy6W3G8MtE7er5gSm8yF6hBec7jPOyh8Ft"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.248.0/LICENSE
```

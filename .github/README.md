...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.515.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.515.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c4W+lehrelNQ5CFGfzkGx9PmHokkatm2pMe/oMmJQZ9C7CWAB5cO+QrrIv0EZkfn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.515.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.515.0/index.min.mjs": "sha384-c4W+lehrelNQ5CFGfzkGx9PmHokkatm2pMe/oMmJQZ9C7CWAB5cO+QrrIv0EZkfn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.515.0/LICENSE
```

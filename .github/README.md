...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Jt6e5IZqIv/Fdi1gm1m7rl9LxEkzKHrkRCuUaDbwsxlGedToCdYNKOD2MJt84JdL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.92.0/index.min.mjs": "sha384-Jt6e5IZqIv/Fdi1gm1m7rl9LxEkzKHrkRCuUaDbwsxlGedToCdYNKOD2MJt84JdL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.92.0/LICENSE
```

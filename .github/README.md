...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.31.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.31.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I4Oml1jBKccEW7UNBepXWx1zvoIwzIUg7sQTsOlAWFrxGHZD2TMcyYdyiNwRujNT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.31.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.31.0/index.min.mjs": "sha384-I4Oml1jBKccEW7UNBepXWx1zvoIwzIUg7sQTsOlAWFrxGHZD2TMcyYdyiNwRujNT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.31.0/LICENSE
```

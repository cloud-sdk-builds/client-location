...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1002.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1002.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rj3T3Wvqc4mDYYdKDMbSSaMH4FzVUQGLlrTSMuowrkYqUOI5Q7JjBhLpW+YmUX7u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1002.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1002.0/index.min.mjs": "sha384-rj3T3Wvqc4mDYYdKDMbSSaMH4FzVUQGLlrTSMuowrkYqUOI5Q7JjBhLpW+YmUX7u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1002.0/LICENSE
```

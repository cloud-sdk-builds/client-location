...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8JBVvsfJJnDp5G8l2qWZMq3M58NKlJ2ecqCNnGpK+2/abs/htKtyB2Js8EqOoVhX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.798.0/index.min.mjs": "sha384-8JBVvsfJJnDp5G8l2qWZMq3M58NKlJ2ecqCNnGpK+2/abs/htKtyB2Js8EqOoVhX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.798.0/LICENSE
```

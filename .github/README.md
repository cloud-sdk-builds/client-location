...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-libPBNH9YE3UXjLhsEnk9eWoM2ni9aHMFigLPJiMsSxWKZcLNq8sbpUj+xpReIgW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.288.0/index.min.mjs": "sha384-libPBNH9YE3UXjLhsEnk9eWoM2ni9aHMFigLPJiMsSxWKZcLNq8sbpUj+xpReIgW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.288.0/LICENSE
```

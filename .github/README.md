...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.266.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.266.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-wjr0gKIBDUgpWXrEdPEwuR5+fJAoYennY6rtpoob363aiCGufa1waTXTTIKLhszR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.266.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.266.1/index.min.mjs": "sha384-wjr0gKIBDUgpWXrEdPEwuR5+fJAoYennY6rtpoob363aiCGufa1waTXTTIKLhszR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.266.1/LICENSE
```

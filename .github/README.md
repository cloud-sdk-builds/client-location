...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.856.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.856.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nio6ughWejbHp2t7qq+e27wBecd3/r6L1HKmyPBIEt02Bx6y2vlXIDKyOJxnBTLb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.856.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.856.0/index.min.mjs": "sha384-nio6ughWejbHp2t7qq+e27wBecd3/r6L1HKmyPBIEt02Bx6y2vlXIDKyOJxnBTLb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.856.0/LICENSE
```

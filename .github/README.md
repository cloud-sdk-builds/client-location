...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.294.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.294.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T0lwLAi3Dcpw95upWuik/MyGnGscyfbDEayJtQn234AasT7GB9TQp3DOzE39Ofxs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.294.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.294.0/index.min.mjs": "sha384-T0lwLAi3Dcpw95upWuik/MyGnGscyfbDEayJtQn234AasT7GB9TQp3DOzE39Ofxs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.294.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.211.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.211.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BwxMElXH6YTCTzR5BWIoRoZ4dkJ9TT5L/bCj9FL9Eea5jiaMZqtjQ/kKqZ279sS3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.211.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.211.0/index.min.mjs": "sha384-BwxMElXH6YTCTzR5BWIoRoZ4dkJ9TT5L/bCj9FL9Eea5jiaMZqtjQ/kKqZ279sS3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.211.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1020.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1020.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v3+BwFxh1WnXanfx5fo6P3DXebHk5ak8mSPfzmyQL6b4qHa9BofHa8QluEjCz8kN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1020.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1020.0/index.min.mjs": "sha384-v3+BwFxh1WnXanfx5fo6P3DXebHk5ak8mSPfzmyQL6b4qHa9BofHa8QluEjCz8kN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1020.0/LICENSE
```

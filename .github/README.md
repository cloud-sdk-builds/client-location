...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cF4x2gMxSAJp4pJffM8fV8ZR2qUbCXc/+e+6zHA8qkN5v6mqu6uugXw0F+IgXT8T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.952.0/index.min.mjs": "sha384-cF4x2gMxSAJp4pJffM8fV8ZR2qUbCXc/+e+6zHA8qkN5v6mqu6uugXw0F+IgXT8T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.952.0/LICENSE
```

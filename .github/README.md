...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-65n9lTManKDWWnC5yHiAIEp+nSQfKmm0X+jJc4tZU7RJ9uD4v929ZncvXbQRJKbC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.686.0/index.min.mjs": "sha384-65n9lTManKDWWnC5yHiAIEp+nSQfKmm0X+jJc4tZU7RJ9uD4v929ZncvXbQRJKbC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.686.0/LICENSE
```

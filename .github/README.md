...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HJuE82mH16dl+HF1g/BA/lTvY2u6ENL521FxwcSJKBc4Wj/J+sqN+2vxpSQwBNGQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.26.0/index.min.mjs": "sha384-HJuE82mH16dl+HF1g/BA/lTvY2u6ENL521FxwcSJKBc4Wj/J+sqN+2vxpSQwBNGQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.26.0/LICENSE
```

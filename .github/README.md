...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.830.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.830.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-paknczHh+eogfHTRgZu/sqX804y+oIJByyjSac7WLPv4GjdYg9KhNEoxropzoGR/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.830.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.830.0/index.min.mjs": "sha384-paknczHh+eogfHTRgZu/sqX804y+oIJByyjSac7WLPv4GjdYg9KhNEoxropzoGR/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.830.0/LICENSE
```

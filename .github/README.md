...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.920.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.920.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K1LtYjGMyWR4SHYnhk+kVQm+vS9/R607ca7DTSwbnIKzsHAtJHRV0eQQjIUXvOb5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.920.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.920.0/index.min.mjs": "sha384-K1LtYjGMyWR4SHYnhk+kVQm+vS9/R607ca7DTSwbnIKzsHAtJHRV0eQQjIUXvOb5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.920.0/LICENSE
```

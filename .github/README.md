...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L1KkgEwrNt9XQePqzIHvPKEAzUKVlmlzZQUMQRsobS0UTcgIIOtovU45+vKmH2rk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.631.0/index.min.mjs": "sha384-L1KkgEwrNt9XQePqzIHvPKEAzUKVlmlzZQUMQRsobS0UTcgIIOtovU45+vKmH2rk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.631.0/LICENSE
```

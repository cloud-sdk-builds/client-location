...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4K+TWs2Dz09mnC35FPm3D+em4qVhZ/1mfmCad0YRa3CkeYWWt2bRH9X45t9guxU2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.713.0/index.min.mjs": "sha384-4K+TWs2Dz09mnC35FPm3D+em4qVhZ/1mfmCad0YRa3CkeYWWt2bRH9X45t9guxU2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.713.0/LICENSE
```

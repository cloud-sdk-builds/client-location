...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s8IXVO8NhaPH6DMxWu90mktcI0PBGYC52vWrWZx9m0H8uxkAJdyX4/zAJ1ul1CxR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.936.0/index.min.mjs": "sha384-s8IXVO8NhaPH6DMxWu90mktcI0PBGYC52vWrWZx9m0H8uxkAJdyX4/zAJ1ul1CxR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.936.0/LICENSE
```

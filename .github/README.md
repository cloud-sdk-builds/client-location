...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.817.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.817.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S/4J73vuHUZ6VCO/+64H1KfMV7ClB+u2PU0YXQcTmCUfssi8IOfNkhiineIwyH9T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.817.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.817.0/index.min.mjs": "sha384-S/4J73vuHUZ6VCO/+64H1KfMV7ClB+u2PU0YXQcTmCUfssi8IOfNkhiineIwyH9T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.817.0/LICENSE
```

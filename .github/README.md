...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sBw6qrWPNIL7lwsWI7QPzSeCHRRYL+JpxfFkGgO2D8Oi5P0tRCZ01sg8zMtZZsc8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.24.0/index.min.mjs": "sha384-sBw6qrWPNIL7lwsWI7QPzSeCHRRYL+JpxfFkGgO2D8Oi5P0tRCZ01sg8zMtZZsc8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.24.0/LICENSE
```

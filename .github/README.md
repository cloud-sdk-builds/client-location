...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l8iWWvSUdyGFTSKx8G2Fu8jaqOLBnfARb1c1uJ2zeKTp1GHW04TTdl8PsUeH2pns
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.925.0/index.min.mjs": "sha384-l8iWWvSUdyGFTSKx8G2Fu8jaqOLBnfARb1c1uJ2zeKTp1GHW04TTdl8PsUeH2pns"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.925.0/LICENSE
```

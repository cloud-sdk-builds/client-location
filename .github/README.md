...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.41.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.41.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XEHV+JyrLm6sfzs9pDly4ybgOvcfPowYR0WgmK3HOA7gJrw8QTUy3stmThe5pG+R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.41.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.41.0/index.min.mjs": "sha384-XEHV+JyrLm6sfzs9pDly4ybgOvcfPowYR0WgmK3HOA7gJrw8QTUy3stmThe5pG+R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.41.0/LICENSE
```

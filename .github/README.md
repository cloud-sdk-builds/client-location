...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L0Hiv0PMLATryPDT4Oo/nfbtN6lRqfSDozCz7pGjO7PNWmNe0ra6ecmwNZRkCXbG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.848.0/index.min.mjs": "sha384-L0Hiv0PMLATryPDT4Oo/nfbtN6lRqfSDozCz7pGjO7PNWmNe0ra6ecmwNZRkCXbG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.848.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dWy9H9WBRun/1AVJ7UzcP2VxFdiksW0vkDlJzCBEtSEFhwAQ2d0+8BbJrqo+/QxW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.908.0/index.min.mjs": "sha384-dWy9H9WBRun/1AVJ7UzcP2VxFdiksW0vkDlJzCBEtSEFhwAQ2d0+8BbJrqo+/QxW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.908.0/LICENSE
```

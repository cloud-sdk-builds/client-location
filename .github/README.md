...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r651Ry2/EXw6H9z42CEp2GxoQ00u8wKVD52OnJvTb5yweXQaNLte3bvmoP676Ki5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.54.0/index.min.mjs": "sha384-r651Ry2/EXw6H9z42CEp2GxoQ00u8wKVD52OnJvTb5yweXQaNLte3bvmoP676Ki5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.54.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.293.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.293.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gN3DyZUX9NNqbDj6nWTxMhoQ1hdMHSHdFd7JVS8MQlirx3MLpURTemsxsx7icMHp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.293.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.293.0/index.min.mjs": "sha384-gN3DyZUX9NNqbDj6nWTxMhoQ1hdMHSHdFd7JVS8MQlirx3MLpURTemsxsx7icMHp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.293.0/LICENSE
```

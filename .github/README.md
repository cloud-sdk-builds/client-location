...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.449.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.449.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jyHEtGUZGaPNQ9hP7mhV4Bxk6BvaeeyfzzU7m9bdVxn2ZNj2gpPLE1uKqq71JRLR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.449.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.449.0/index.min.mjs": "sha384-jyHEtGUZGaPNQ9hP7mhV4Bxk6BvaeeyfzzU7m9bdVxn2ZNj2gpPLE1uKqq71JRLR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.449.0/LICENSE
```

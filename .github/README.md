...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9okZqUSYti4zJEwNpsHhZU5kMAPlDlcUPrPskXYp23CToWZmj2ZokNKz7xDI8QBi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.441.0/index.min.mjs": "sha384-9okZqUSYti4zJEwNpsHhZU5kMAPlDlcUPrPskXYp23CToWZmj2ZokNKz7xDI8QBi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.441.0/LICENSE
```

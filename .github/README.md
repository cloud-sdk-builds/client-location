...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-++UzP1VCDWxpS/izYgFYRTqqTD1RZ70VZfJUdZGdJy9M8Ai36ihGYDeMTp8J9js5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.552.0/index.min.mjs": "sha384-++UzP1VCDWxpS/izYgFYRTqqTD1RZ70VZfJUdZGdJy9M8Ai36ihGYDeMTp8J9js5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.552.0/LICENSE
```

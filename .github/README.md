...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zz3DARTr2mwvSEHq5GJ+KTjC1aF+2i05n4tDUQoIkRSuqqgfs1PZWjO+2HmEb4mO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.85.0/index.min.mjs": "sha384-Zz3DARTr2mwvSEHq5GJ+KTjC1aF+2i05n4tDUQoIkRSuqqgfs1PZWjO+2HmEb4mO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.85.0/LICENSE
```

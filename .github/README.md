...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N96FzA6BN7hEcDb4WwLKc6GzmYii9tIgrXpJpNRfcCR6LRoQyxAJQFrq6PudFJgs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.292.0/index.min.mjs": "sha384-N96FzA6BN7hEcDb4WwLKc6GzmYii9tIgrXpJpNRfcCR6LRoQyxAJQFrq6PudFJgs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.292.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t2thzuTOp1Dm6ITDSW3BidHRvxEJuxSSTchRA3k2JU8obb08nDYFG2rwCDb6nm7N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.716.0/index.min.mjs": "sha384-t2thzuTOp1Dm6ITDSW3BidHRvxEJuxSSTchRA3k2JU8obb08nDYFG2rwCDb6nm7N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.716.0/LICENSE
```

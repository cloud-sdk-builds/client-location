...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gSPOwNDX0CUWQCk1c2eKEWCprZt0GsCjGx7wfvoA3d4cJeRLKlkL7y97B7Zabj8d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.52.0/index.min.mjs": "sha384-gSPOwNDX0CUWQCk1c2eKEWCprZt0GsCjGx7wfvoA3d4cJeRLKlkL7y97B7Zabj8d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.52.0/LICENSE
```

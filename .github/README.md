...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-johLwyXJsarwOmKXQDiuki/cZzY1vHPmBVmmlkckHZFFtlaDF38NTfiCyvJ0ETUt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.170.0/index.min.mjs": "sha384-johLwyXJsarwOmKXQDiuki/cZzY1vHPmBVmmlkckHZFFtlaDF38NTfiCyvJ0ETUt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.170.0/LICENSE
```

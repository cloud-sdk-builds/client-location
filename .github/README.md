...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-NdRTM5cQwsn6TKccsCfipth3VZzyGI0pd1MnbQzEBtwkLuCDFQ984ooG7HseAgL6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.620.1/index.min.mjs": "sha384-NdRTM5cQwsn6TKccsCfipth3VZzyGI0pd1MnbQzEBtwkLuCDFQ984ooG7HseAgL6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.620.1/LICENSE
```

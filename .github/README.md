...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9Nw8f0JDlHz0nPe2XpZOjO7rway42O1owDmTHUDug/H+U2hEwAYs8fjBfz/31dky
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.241.0/index.min.mjs": "sha384-9Nw8f0JDlHz0nPe2XpZOjO7rway42O1owDmTHUDug/H+U2hEwAYs8fjBfz/31dky"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.241.0/LICENSE
```

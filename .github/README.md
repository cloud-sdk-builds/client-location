...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.675.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.675.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FJ8qfPJPstl8t5LZgVj0mlN8nj6EtIuZZNORIrCmIgQZLSH1r+Lc3m30ZTPWQfSy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.675.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.675.0/index.min.mjs": "sha384-FJ8qfPJPstl8t5LZgVj0mlN8nj6EtIuZZNORIrCmIgQZLSH1r+Lc3m30ZTPWQfSy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.675.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-MoPRx7uwoHlQVNs0jVJ4Spec+Td4FINxklGM97PqnJ84uHDqR+1psXW1xoDuvu+O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.731.1/index.min.mjs": "sha384-MoPRx7uwoHlQVNs0jVJ4Spec+Td4FINxklGM97PqnJ84uHDqR+1psXW1xoDuvu+O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.731.1/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.721.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.721.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xxFDUN6TtbltFUjGFZlYIMfzrgB4y3NSa9Fslwzi6Yv4VoPTkmkSnEctfMpT6l3b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.721.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.721.0/index.min.mjs": "sha384-xxFDUN6TtbltFUjGFZlYIMfzrgB4y3NSa9Fslwzi6Yv4VoPTkmkSnEctfMpT6l3b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.721.0/LICENSE
```

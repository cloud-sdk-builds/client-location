...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jmWVjB5TTrz0lLjoYKsdMLoLiipwgr2TuJR6qpAQmkJ0iB4Wo1Gl4mvE2PtpmFrq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.978.0/index.min.mjs": "sha384-jmWVjB5TTrz0lLjoYKsdMLoLiipwgr2TuJR6qpAQmkJ0iB4Wo1Gl4mvE2PtpmFrq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.978.0/LICENSE
```

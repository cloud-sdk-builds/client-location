...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OcaJqzAumDu3wAgvItpm9D0MXxMxqxTw6Lh+TBGO1y4J8ndd68bbdLi/vZMRyNu4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.94.0/index.min.mjs": "sha384-OcaJqzAumDu3wAgvItpm9D0MXxMxqxTw6Lh+TBGO1y4J8ndd68bbdLi/vZMRyNu4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.94.0/LICENSE
```

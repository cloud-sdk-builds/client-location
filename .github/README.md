...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1009.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1009.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sIFhOVbTktg+UvFzCLtSCQr904Nb/fEURd8My+Z8ZwZyKRDdWm4VPGXgUIMYe2Vk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1009.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1009.0/index.min.mjs": "sha384-sIFhOVbTktg+UvFzCLtSCQr904Nb/fEURd8My+Z8ZwZyKRDdWm4VPGXgUIMYe2Vk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1009.0/LICENSE
```

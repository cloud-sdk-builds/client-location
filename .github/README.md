...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.159.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.159.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j6jf3BUCsWNuLGZNPrm/76HecKwe7bYf4xaiXvUDtgjlU0KCwJ8iS7+GtL0qGx7u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.159.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.159.0/index.min.mjs": "sha384-j6jf3BUCsWNuLGZNPrm/76HecKwe7bYf4xaiXvUDtgjlU0KCwJ8iS7+GtL0qGx7u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.159.0/LICENSE
```

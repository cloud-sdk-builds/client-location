...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6PGyak5alB0AlQGA2m0/NTyrY1WvXemL7p0oQcTQIyFm9HzdVM/hAd3OHzuor0bC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.282.0/index.min.mjs": "sha384-6PGyak5alB0AlQGA2m0/NTyrY1WvXemL7p0oQcTQIyFm9HzdVM/hAd3OHzuor0bC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.282.0/LICENSE
```

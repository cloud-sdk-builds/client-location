...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.28.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.28.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kx8KikseJg8NeXeHhsFKU9TgY7ZKY0LUdKVFW1kOGIR8HOyx6ia4oxOq6PMQDuWv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.28.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.28.0/index.min.mjs": "sha384-kx8KikseJg8NeXeHhsFKU9TgY7ZKY0LUdKVFW1kOGIR8HOyx6ia4oxOq6PMQDuWv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.28.0/LICENSE
```

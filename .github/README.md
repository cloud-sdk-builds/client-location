...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-quu4OPrEJ7cJKAbsQZG29rzOjRDJT4NXwA+cyKWCcDJ2I9+ItqRoBSYE4Twetv87
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.985.0/index.min.mjs": "sha384-quu4OPrEJ7cJKAbsQZG29rzOjRDJT4NXwA+cyKWCcDJ2I9+ItqRoBSYE4Twetv87"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.985.0/LICENSE
```

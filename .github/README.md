...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.981.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8skXhtxNOZ5gADN5mLeIF2O05eKPSrLnLblE6/wnDL9kl3aj8guNsF9S0iJJ62O8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.981.0/index.min.mjs": "sha384-8skXhtxNOZ5gADN5mLeIF2O05eKPSrLnLblE6/wnDL9kl3aj8guNsF9S0iJJ62O8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.981.0/LICENSE
```

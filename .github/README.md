...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4B2sSvfdkxO+2uM5nF0SFqbkGL2EFPbDjdxuh7j4r0PIBcpkG4IocoXWcSjVG3QH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.245.0/index.min.mjs": "sha384-4B2sSvfdkxO+2uM5nF0SFqbkGL2EFPbDjdxuh7j4r0PIBcpkG4IocoXWcSjVG3QH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.245.0/LICENSE
```

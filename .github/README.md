...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lGlg2LE66zgkDcMP5b/AgqAi6xiXepjOyPEohT1N4JL6fppBqrA/cgim5HXNjfeY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.272.0/index.min.mjs": "sha384-lGlg2LE66zgkDcMP5b/AgqAi6xiXepjOyPEohT1N4JL6fppBqrA/cgim5HXNjfeY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.272.0/LICENSE
```

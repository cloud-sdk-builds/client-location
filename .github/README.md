...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.621.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.621.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-41xi6R/7XORsM43ng21qiXCczOd7ay3DPHh6XnmDoNWNZC1ZNPrvfHwNFb9FuUk1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.621.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.621.0/index.min.mjs": "sha384-41xi6R/7XORsM43ng21qiXCczOd7ay3DPHh6XnmDoNWNZC1ZNPrvfHwNFb9FuUk1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.621.0/LICENSE
```

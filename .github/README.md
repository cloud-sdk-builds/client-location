...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ev7hFEYcA2QUq+g+/J+289rg7sH06+tEWXU5u1lFP/L5V55iur0UCyLlb+ZaKd0A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.345.0/index.min.mjs": "sha384-Ev7hFEYcA2QUq+g+/J+289rg7sH06+tEWXU5u1lFP/L5V55iur0UCyLlb+ZaKd0A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.345.0/LICENSE
```

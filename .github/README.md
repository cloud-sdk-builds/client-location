...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HAJi7UJgnlCaLo+u+bPBhxp1GlmHK4u00Rf3j6EVbv4g/Cm2YM9xlJ6SyyHxoFWd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.994.0/index.min.mjs": "sha384-HAJi7UJgnlCaLo+u+bPBhxp1GlmHK4u00Rf3j6EVbv4g/Cm2YM9xlJ6SyyHxoFWd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.994.0/LICENSE
```

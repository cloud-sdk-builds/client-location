...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mrr71P7L4FhxGbWOzKrM7Z9F4UGjiDXKOGCDopXSolJJlH1XZQcLFrJIBNzuK7U5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.749.0/index.min.mjs": "sha384-Mrr71P7L4FhxGbWOzKrM7Z9F4UGjiDXKOGCDopXSolJJlH1XZQcLFrJIBNzuK7U5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.749.0/LICENSE
```

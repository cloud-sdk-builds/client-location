...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.461.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.461.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uw8oKPqryKN7+PRC+eACqv/9KQLpb6ho1wxw4SjcbCY0CTByWPWiAMtuVI/Jpjgb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.461.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.461.0/index.min.mjs": "sha384-uw8oKPqryKN7+PRC+eACqv/9KQLpb6ho1wxw4SjcbCY0CTByWPWiAMtuVI/Jpjgb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.461.0/LICENSE
```

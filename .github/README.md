...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0NDwMy8V0iiLctRAdv+KKyacKPY4MCJQOsPf+I86D7cH0CZj8m2lq6ap1QTseBwI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.563.0/index.min.mjs": "sha384-0NDwMy8V0iiLctRAdv+KKyacKPY4MCJQOsPf+I86D7cH0CZj8m2lq6ap1QTseBwI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.563.0/LICENSE
```

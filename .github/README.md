...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2iWQRrUOHp5KcZVVZanUuqV6LbfRHKqiRpAor14Js0E51Q+0QteUFJyiADg9Q2ai
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.846.0/index.min.mjs": "sha384-2iWQRrUOHp5KcZVVZanUuqV6LbfRHKqiRpAor14Js0E51Q+0QteUFJyiADg9Q2ai"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.846.0/LICENSE
```

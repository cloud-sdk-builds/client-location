...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.598.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.598.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7F4u5dk6f0iDntR5lf5fUjjZ1wWj4a5KZNwkRf4xmr3b8fue4tGOQmiXAtOBe/z9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.598.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.598.0/index.min.mjs": "sha384-7F4u5dk6f0iDntR5lf5fUjjZ1wWj4a5KZNwkRf4xmr3b8fue4tGOQmiXAtOBe/z9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.598.0/LICENSE
```

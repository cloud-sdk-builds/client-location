...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.279.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.279.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jPw5fw+Buhc6lhIAvVruTa7hlVgpmQCnAt8U7vmdMD7CiLU7ZwkWLWiruxhQNA7T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.279.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.279.0/index.min.mjs": "sha384-jPw5fw+Buhc6lhIAvVruTa7hlVgpmQCnAt8U7vmdMD7CiLU7ZwkWLWiruxhQNA7T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.279.0/LICENSE
```

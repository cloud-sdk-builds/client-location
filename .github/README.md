...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.668.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.668.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-htaIvq7HncJfQ8dwHNdu3hukZEdLp7lzHxcXgcBkKjx27btndUA9ZrNqY+PAWTcV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.668.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.668.0/index.min.mjs": "sha384-htaIvq7HncJfQ8dwHNdu3hukZEdLp7lzHxcXgcBkKjx27btndUA9ZrNqY+PAWTcV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.668.0/LICENSE
```

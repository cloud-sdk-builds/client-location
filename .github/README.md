...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.321.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.321.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-WXuSP+T513qSuGWisU+OvjIvAZVfQeqIAeU7PcBxb7Qrpd4RnFdt0L5Pf5bgr8iX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.321.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.321.1/index.min.mjs": "sha384-WXuSP+T513qSuGWisU+OvjIvAZVfQeqIAeU7PcBxb7Qrpd4RnFdt0L5Pf5bgr8iX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.321.1/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/MLufXb0aWpE91viFUAfhu9sK07mR9EAY+OhD3J12kTInO/W2W3v8MUbgOYj6vIw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.919.0/index.min.mjs": "sha384-/MLufXb0aWpE91viFUAfhu9sK07mR9EAY+OhD3J12kTInO/W2W3v8MUbgOYj6vIw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.919.0/LICENSE
```

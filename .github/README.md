...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DEx3tCbRG8i/9h0xq9tdja5hkiJzxiFkBWcCmygr0z69NuuEF6woePictf/7SvaX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.37.0/index.min.mjs": "sha384-DEx3tCbRG8i/9h0xq9tdja5hkiJzxiFkBWcCmygr0z69NuuEF6woePictf/7SvaX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.37.0/LICENSE
```

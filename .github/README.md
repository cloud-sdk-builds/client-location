...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aHsaq2EVXwvLvHLSJZbx/b6Z/MwXAjgpnk73oXezaU8Y0VbmW7DNx9L+sg2u/0VY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.935.0/index.min.mjs": "sha384-aHsaq2EVXwvLvHLSJZbx/b6Z/MwXAjgpnk73oXezaU8Y0VbmW7DNx9L+sg2u/0VY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.935.0/LICENSE
```

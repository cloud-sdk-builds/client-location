...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Btn3pK6sPXAytCtgLRdogBPQkJexIo1kEBedlh0ykBY529nC5RB/UzszmOaHxY2z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.222.0/index.min.mjs": "sha384-Btn3pK6sPXAytCtgLRdogBPQkJexIo1kEBedlh0ykBY529nC5RB/UzszmOaHxY2z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.222.0/LICENSE
```

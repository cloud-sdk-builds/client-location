...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.894.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.894.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2BM2oh2FFhS+cuU0XFRufTZ3u1PLMd9ciNFwr4oqV0ZIn1v7uBdFW3Mm6Qazvx3I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.894.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.894.0/index.min.mjs": "sha384-2BM2oh2FFhS+cuU0XFRufTZ3u1PLMd9ciNFwr4oqV0ZIn1v7uBdFW3Mm6Qazvx3I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.894.0/LICENSE
```

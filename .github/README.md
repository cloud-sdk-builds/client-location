...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-W1RWmotLMNHo4VqrOdyvaonkbxJu+yUJO1XToA+LYINkvnk53pvuzAw7WX8iiG/C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.54.1/index.min.mjs": "sha384-W1RWmotLMNHo4VqrOdyvaonkbxJu+yUJO1XToA+LYINkvnk53pvuzAw7WX8iiG/C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.54.1/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DwAYkso8admYR8wuHEvMgI8Z3Qro3u9Pup5enQT8yURaQ15R0xCP534OwtfZn5Xa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.40.0/index.min.mjs": "sha384-DwAYkso8admYR8wuHEvMgI8Z3Qro3u9Pup5enQT8yURaQ15R0xCP534OwtfZn5Xa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.40.0/LICENSE
```

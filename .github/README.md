...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1033.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1033.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QxSjEBfjCWTqq3b2926+A8sr1e6Nrk4Ui8M0JcqjVnUOf0wNqLTjMc7Trzyaopfs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1033.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1033.0/index.min.mjs": "sha384-QxSjEBfjCWTqq3b2926+A8sr1e6Nrk4Ui8M0JcqjVnUOf0wNqLTjMc7Trzyaopfs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1033.0/LICENSE
```

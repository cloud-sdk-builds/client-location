...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-abPwsqvgUB2V/aHlO0rFxHuBqc/4iJOgUwD4UhzH55D/Y8u6OKrpO+845uN2iLZJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.929.0/index.min.mjs": "sha384-abPwsqvgUB2V/aHlO0rFxHuBqc/4iJOgUwD4UhzH55D/Y8u6OKrpO+845uN2iLZJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.929.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/mf64EXmbzF1Pssfb7FFMSEuV4Ayav34QlmDXI3Z+H8oNJ+qF38c76QVjes/XWOB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.654.0/index.min.mjs": "sha384-/mf64EXmbzF1Pssfb7FFMSEuV4Ayav34QlmDXI3Z+H8oNJ+qF38c76QVjes/XWOB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.654.0/LICENSE
```

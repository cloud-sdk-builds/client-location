...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zc6vYZpMsRC2rF/PYKA3iUe30LEkVcSmSReZXoQshkTd3/Am6ziox96VKASKd+mI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.35.0/index.min.mjs": "sha384-Zc6vYZpMsRC2rF/PYKA3iUe30LEkVcSmSReZXoQshkTd3/Am6ziox96VKASKd+mI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.35.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nQmvRcAEI9KsHdYvzbjHgPsHto0riJXgy9lGf1skTgOPq542uDoQsrkPyMsaMQF5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.521.0/index.min.mjs": "sha384-nQmvRcAEI9KsHdYvzbjHgPsHto0riJXgy9lGf1skTgOPq542uDoQsrkPyMsaMQF5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.521.0/LICENSE
```

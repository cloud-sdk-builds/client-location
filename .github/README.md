...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DQsC12vrR/ObZtg1EiyipX0UAEcUm/V+OBoW69XPJCw1thefbTg7fL8/gp3Cc7wQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.825.0/index.min.mjs": "sha384-DQsC12vrR/ObZtg1EiyipX0UAEcUm/V+OBoW69XPJCw1thefbTg7fL8/gp3Cc7wQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.825.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UQHTUMdj1qJ17GIYg5jDudW5zBl0BUxkl7Nhqew74Y6qRhjUX+1fZeOCWMEti+wb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.650.0/index.min.mjs": "sha384-UQHTUMdj1qJ17GIYg5jDudW5zBl0BUxkl7Nhqew74Y6qRhjUX+1fZeOCWMEti+wb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.650.0/LICENSE
```

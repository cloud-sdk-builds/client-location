...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.99.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.99.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AGZY3z4Jpb8VGH2fGti570cwhrewBcqM7phsUuMf+RWoH9A20boEZS0u1DH3XAg1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.99.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.99.0/index.min.mjs": "sha384-AGZY3z4Jpb8VGH2fGti570cwhrewBcqM7phsUuMf+RWoH9A20boEZS0u1DH3XAg1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.99.0/LICENSE
```

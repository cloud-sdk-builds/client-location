...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.51.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.51.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1p/qtWPH8wDhoC1C+WPqdVhNe7OtyZnjquV2WZNQd+74eBDUW+zovrbRdk/2Jkni
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.51.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.51.0/index.min.mjs": "sha384-1p/qtWPH8wDhoC1C+WPqdVhNe7OtyZnjquV2WZNQd+74eBDUW+zovrbRdk/2Jkni"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.51.0/LICENSE
```

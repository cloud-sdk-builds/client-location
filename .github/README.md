...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PgU0Go3FbZoJbSRCqCimh3rJt3c/07CEz3prOreLz/8wII04nldvwZp4VHAdHc8f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.876.0/index.min.mjs": "sha384-PgU0Go3FbZoJbSRCqCimh3rJt3c/07CEz3prOreLz/8wII04nldvwZp4VHAdHc8f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.876.0/LICENSE
```

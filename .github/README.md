...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1027.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1027.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-90Of6Gm5ztMn5VKfaVIcnkMUZWSyX3ifhMhLzuQzGjbQ9uCFjmViz3+D84f2Dfvx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1027.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1027.0/index.min.mjs": "sha384-90Of6Gm5ztMn5VKfaVIcnkMUZWSyX3ifhMhLzuQzGjbQ9uCFjmViz3+D84f2Dfvx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1027.0/LICENSE
```

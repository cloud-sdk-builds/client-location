...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1tztdbeJXnKNlh2Jme3j/1fn9aN0Rz8RtRTsdv85SBpwoCngbKM68IVxGdW6mDcC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.997.0/index.min.mjs": "sha384-1tztdbeJXnKNlh2Jme3j/1fn9aN0Rz8RtRTsdv85SBpwoCngbKM68IVxGdW6mDcC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.997.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.165.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.165.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hfG5lXUPaHPcDArW8U4whygLze5AB4VXJzlYCqfSSSqlGRr80wMAJP+1R1ihkO8s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.165.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.165.0/index.min.mjs": "sha384-hfG5lXUPaHPcDArW8U4whygLze5AB4VXJzlYCqfSSSqlGRr80wMAJP+1R1ihkO8s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.165.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dWj2uUO6WuUUXuBUWK0KeBDBvBR6W8gCSoO9+Qm7vwSHyMakr339wND4zXjQbtpN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.986.0/index.min.mjs": "sha384-dWj2uUO6WuUUXuBUWK0KeBDBvBR6W8gCSoO9+Qm7vwSHyMakr339wND4zXjQbtpN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.986.0/LICENSE
```

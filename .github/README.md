...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CcjgZbDNwJQEOx0o0HH215+vcQGwMFxCoVDu8MyWdzKVoBRa0UnX9oQiRBXA9BwU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.224.0/index.min.mjs": "sha384-CcjgZbDNwJQEOx0o0HH215+vcQGwMFxCoVDu8MyWdzKVoBRa0UnX9oQiRBXA9BwU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.224.0/LICENSE
```

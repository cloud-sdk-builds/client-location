...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.883.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.883.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ebW3KMU9aAh0oy3bALeLEmkNT6Ma7bkJ42zOiJ3iY4hiEgtrd3ZdAkdcj9n/2a21
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.883.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.883.0/index.min.mjs": "sha384-ebW3KMU9aAh0oy3bALeLEmkNT6Ma7bkJ42zOiJ3iY4hiEgtrd3ZdAkdcj9n/2a21"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.883.0/LICENSE
```

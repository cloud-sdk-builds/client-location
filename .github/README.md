...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.186.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.186.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-vR7grUXp060iogVkcjAC6n/SMonYyjJfxCQTqiRhXVnzRUJSJej0JAkRfgagfYB0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.186.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.186.1/index.min.mjs": "sha384-vR7grUXp060iogVkcjAC6n/SMonYyjJfxCQTqiRhXVnzRUJSJej0JAkRfgagfYB0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.186.1/LICENSE
```

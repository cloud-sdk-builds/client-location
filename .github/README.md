...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1029.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1029.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K88oqMC2NnqdBPq5NCubPuq3703p96I6DbxSNg/8xSz2/ZaBdcXuLiuKHtfwEPT4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1029.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1029.0/index.min.mjs": "sha384-K88oqMC2NnqdBPq5NCubPuq3703p96I6DbxSNg/8xSz2/ZaBdcXuLiuKHtfwEPT4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1029.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.363.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.363.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nuBIxVwxlLmarKBu2bKvCs6YIL1kH0qM3V8RDccTtsB2NRr6SeWLokeczlfQ//tB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.363.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.363.0/index.min.mjs": "sha384-nuBIxVwxlLmarKBu2bKvCs6YIL1kH0qM3V8RDccTtsB2NRr6SeWLokeczlfQ//tB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.363.0/LICENSE
```

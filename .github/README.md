...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.953.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.953.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TGbwADFOa4ze6/we9stexHE5hkmGfNwCcMjh6gg/t57jhlS0IZ8iFRESscSkuSnP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.953.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.953.0/index.min.mjs": "sha384-TGbwADFOa4ze6/we9stexHE5hkmGfNwCcMjh6gg/t57jhlS0IZ8iFRESscSkuSnP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.953.0/LICENSE
```

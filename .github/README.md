...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.499.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.499.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QzigXegmVdeXZtRa2ex99SyFCesUTdOE0G6X1p6GYjhSwJfHrRXFPromNluXbkpO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.499.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.499.0/index.min.mjs": "sha384-QzigXegmVdeXZtRa2ex99SyFCesUTdOE0G6X1p6GYjhSwJfHrRXFPromNluXbkpO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.499.0/LICENSE
```

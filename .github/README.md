...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.169.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.169.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A0GnWuzaeuDNg1084diZjNMa3Y/B0Q8Kk5qYcWmimtSDwpW3o0NQmCQ+rm6K7xAx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.169.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.169.0/index.min.mjs": "sha384-A0GnWuzaeuDNg1084diZjNMa3Y/B0Q8Kk5qYcWmimtSDwpW3o0NQmCQ+rm6K7xAx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.169.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-KtnKo6S3YAq3xF4ka6e+/rDAjERF4wq17K9efocjzf5Lii+Ic3JSdwFfM3HZffmV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.118.1/index.min.mjs": "sha384-KtnKo6S3YAq3xF4ka6e+/rDAjERF4wq17K9efocjzf5Lii+Ic3JSdwFfM3HZffmV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.118.1/LICENSE
```

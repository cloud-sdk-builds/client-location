...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HSnLgPmZp9f01bUV/ET/5MqS7NHmDORMHBDcnQQb8t080TZ0n455QFW3nd8uQJKe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.29.0/index.min.mjs": "sha384-HSnLgPmZp9f01bUV/ET/5MqS7NHmDORMHBDcnQQb8t080TZ0n455QFW3nd8uQJKe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.29.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.489.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.489.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eUBIu7L6iI09uaQ1UEE5TuuiQUXqq2+cmjiO31aKIjy9r6Z9KWQFMnwFfqFWpMXI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.489.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.489.0/index.min.mjs": "sha384-eUBIu7L6iI09uaQ1UEE5TuuiQUXqq2+cmjiO31aKIjy9r6Z9KWQFMnwFfqFWpMXI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.489.0/LICENSE
```

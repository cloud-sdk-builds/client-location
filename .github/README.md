...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-yq3yMd6ugC0oRQZdVI0beBjCq1jUa2e5YP0EPW5klP+kbiO24lvmI4cxqgHxZU1q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.36.1/index.min.mjs": "sha384-yq3yMd6ugC0oRQZdVI0beBjCq1jUa2e5YP0EPW5klP+kbiO24lvmI4cxqgHxZU1q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.36.1/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TudWy9PufkMCN54zp8Tz+fq/u7iiAOCYETEGVCcHM2FrCmkKvQEe90R0BgHTmMgI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.300.0/index.min.mjs": "sha384-TudWy9PufkMCN54zp8Tz+fq/u7iiAOCYETEGVCcHM2FrCmkKvQEe90R0BgHTmMgI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.300.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1022.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1022.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GWBmHnRbUrU5SaUozyGbcB9E42CWmNSwgTSfqhgctXqRE/9Ov3p7RIj6WhWWV8XB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1022.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1022.0/index.min.mjs": "sha384-GWBmHnRbUrU5SaUozyGbcB9E42CWmNSwgTSfqhgctXqRE/9Ov3p7RIj6WhWWV8XB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1022.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.437.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.437.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wW1Jek1Snpi4f540KgElyILB8yyCecwKwxlc6jf/ZOXjugur7gnt6PBz3Q3LLREQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.437.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.437.0/index.min.mjs": "sha384-wW1Jek1Snpi4f540KgElyILB8yyCecwKwxlc6jf/ZOXjugur7gnt6PBz3Q3LLREQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.437.0/LICENSE
```

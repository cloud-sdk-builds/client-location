...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-OkALICq8qTImbkOIyy+KZ7nVBgcSeR0qXmyDnqEerxh+3/MYi8IYDCN0VEz1mgO6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.47.2/index.min.mjs": "sha384-OkALICq8qTImbkOIyy+KZ7nVBgcSeR0qXmyDnqEerxh+3/MYi8IYDCN0VEz1mgO6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.47.2/LICENSE
```

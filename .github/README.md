...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.507.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.507.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DrLl4Ynt3+STfcZo7ea1fKB9UiFxnwXta3mVdJyK6M+5IoOJP6PwgISWXDRKKVbk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.507.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.507.0/index.min.mjs": "sha384-DrLl4Ynt3+STfcZo7ea1fKB9UiFxnwXta3mVdJyK6M+5IoOJP6PwgISWXDRKKVbk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.507.0/LICENSE
```

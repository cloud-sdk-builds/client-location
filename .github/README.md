...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KJkL/EvJjgLN1bq+AlyrTkPi7EgxjLOfKvr9Dniptcs4V0Scdv89FDrZVKzPJTVP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.835.0/index.min.mjs": "sha384-KJkL/EvJjgLN1bq+AlyrTkPi7EgxjLOfKvr9Dniptcs4V0Scdv89FDrZVKzPJTVP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.835.0/LICENSE
```

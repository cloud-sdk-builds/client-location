...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oA+FGSsaOcb5Yuf/rRH3B1jEwi3EeUQkEoQct3qqvezBQmpn5+VzXablvkiLSO7i
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.408.0/index.min.mjs": "sha384-oA+FGSsaOcb5Yuf/rRH3B1jEwi3EeUQkEoQct3qqvezBQmpn5+VzXablvkiLSO7i"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.408.0/LICENSE
```

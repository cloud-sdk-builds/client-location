...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.509.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.509.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jZmsj6BENx16OiB3ajoPhfckLW7/9MHAYha0VtYISt/rN1TLyhT7Gq2+ppqgkyih
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.509.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.509.0/index.min.mjs": "sha384-jZmsj6BENx16OiB3ajoPhfckLW7/9MHAYha0VtYISt/rN1TLyhT7Gq2+ppqgkyih"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.509.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.178.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.178.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gj6a+1+hTZfwGog8p6/03V+gd56xjEnD5xB+UnS7+q2ntJQDS/W1f86WPe5SpnPg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.178.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.178.0/index.min.mjs": "sha384-Gj6a+1+hTZfwGog8p6/03V+gd56xjEnD5xB+UnS7+q2ntJQDS/W1f86WPe5SpnPg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.178.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.350.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.350.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TbY620AlMkTj0ug1Goam+RCCglisr7/awQn4CwMxuwZYyc2g9NDy9lLivBrFhrj3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.350.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.350.0/index.min.mjs": "sha384-TbY620AlMkTj0ug1Goam+RCCglisr7/awQn4CwMxuwZYyc2g9NDy9lLivBrFhrj3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.350.0/LICENSE
```

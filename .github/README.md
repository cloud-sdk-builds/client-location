...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8vIlEtsON1zUDCB3RF/AVQpPZgP0eC8yBJ0Yv8V3UYbt7QYlefv5QuWzwsZMLZGB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.691.0/index.min.mjs": "sha384-8vIlEtsON1zUDCB3RF/AVQpPZgP0eC8yBJ0Yv8V3UYbt7QYlefv5QuWzwsZMLZGB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.691.0/LICENSE
```

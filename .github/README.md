...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.76.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.76.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m3chGkEO3Mmq3bU/hrV4vg0v1lyWuheZj+tpy9BELBTN142nBfsqMQw3Lt8BgkB/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.76.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.76.0/index.min.mjs": "sha384-m3chGkEO3Mmq3bU/hrV4vg0v1lyWuheZj+tpy9BELBTN142nBfsqMQw3Lt8BgkB/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.76.0/LICENSE
```

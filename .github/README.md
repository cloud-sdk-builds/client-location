...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-haz3CXE37Kg7d6p3f46tAsRsFySlRmy64uEZp6sDgtI9+XzKKI8D0LXPgWrCkyYz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.677.0/index.min.mjs": "sha384-haz3CXE37Kg7d6p3f46tAsRsFySlRmy64uEZp6sDgtI9+XzKKI8D0LXPgWrCkyYz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.677.0/LICENSE
```

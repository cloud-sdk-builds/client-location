...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O7r/YmUNGMnE71CD0YEZIrQcMNnzWOR2z1m4HcKquddpl31ts8SNkBRZ8NrRBpTM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.999.0/index.min.mjs": "sha384-O7r/YmUNGMnE71CD0YEZIrQcMNnzWOR2z1m4HcKquddpl31ts8SNkBRZ8NrRBpTM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.999.0/LICENSE
```

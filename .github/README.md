...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xLee1bEUxUR9/wup8LbysYQktYoCL0kyFt7M5F+W7y2UZu7OSYBqLDvpO98Q/cYl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.873.0/index.min.mjs": "sha384-xLee1bEUxUR9/wup8LbysYQktYoCL0kyFt7M5F+W7y2UZu7OSYBqLDvpO98Q/cYl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.873.0/LICENSE
```

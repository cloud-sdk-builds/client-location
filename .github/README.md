...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L5FiOL7VPkxeytiK2RXTbhMZBETeE2JxsY1EKkrBredHQ7B1hw30uhzYu3+5/spq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.823.0/index.min.mjs": "sha384-L5FiOL7VPkxeytiK2RXTbhMZBETeE2JxsY1EKkrBredHQ7B1hw30uhzYu3+5/spq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.823.0/LICENSE
```

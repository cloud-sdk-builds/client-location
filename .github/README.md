...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EOteBdzUrs7AvKas3mmb1PWNBPLiFyLrfJweUemO0aIiMijWAgY8GlFQ9QgW1x3x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.193.0/index.min.mjs": "sha384-EOteBdzUrs7AvKas3mmb1PWNBPLiFyLrfJweUemO0aIiMijWAgY8GlFQ9QgW1x3x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.193.0/LICENSE
```

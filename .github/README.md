...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6nocQ1DtY1n86ws8ARE8JyWcaBD0juacXQiRuBcRLSpPAFqZEcU5uTlQBPTYe1D6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.360.0/index.min.mjs": "sha384-6nocQ1DtY1n86ws8ARE8JyWcaBD0juacXQiRuBcRLSpPAFqZEcU5uTlQBPTYe1D6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.360.0/LICENSE
```

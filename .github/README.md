...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.564.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.564.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Lxbf+SpMr8Wqj0IYrDRUy+SFkFHTWIkoTqT2lJDgeT3XCkV59bz82ldhb6kAIBFE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.564.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.564.0/index.min.mjs": "sha384-Lxbf+SpMr8Wqj0IYrDRUy+SFkFHTWIkoTqT2lJDgeT3XCkV59bz82ldhb6kAIBFE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.564.0/LICENSE
```

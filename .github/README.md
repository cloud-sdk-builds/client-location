...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.982.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.982.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UKOLR0VVTk1iuFr59QtNn25DQMLSO95Zm3Ub2HPdF1qyfaJU9H5ek6zZsVThGD8K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.982.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.982.0/index.min.mjs": "sha384-UKOLR0VVTk1iuFr59QtNn25DQMLSO95Zm3Ub2HPdF1qyfaJU9H5ek6zZsVThGD8K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.982.0/LICENSE
```

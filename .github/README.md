...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.430.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.430.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hh9z5OTKLSlx2UsDZJey0Cl5D8tuQYAl+8i3px1svTfH7xfQVepve2A3w7QYMBwP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.430.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.430.0/index.min.mjs": "sha384-Hh9z5OTKLSlx2UsDZJey0Cl5D8tuQYAl+8i3px1svTfH7xfQVepve2A3w7QYMBwP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.430.0/LICENSE
```

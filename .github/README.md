...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.395.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.395.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nFSdtAN7OI+yXdM+IW13dPBCWN+SZeP3tamL4j2wWw6dZ5tPvXSaFapY8hNHxpVn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.395.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.395.0/index.min.mjs": "sha384-nFSdtAN7OI+yXdM+IW13dPBCWN+SZeP3tamL4j2wWw6dZ5tPvXSaFapY8hNHxpVn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.395.0/LICENSE
```

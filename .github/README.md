...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tNzaKdhFWNdbYLyps8wcoK4odwgZXV1QlOcYuX4FU0lfly/Vqvprqke9TJyrT/N6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.289.0/index.min.mjs": "sha384-tNzaKdhFWNdbYLyps8wcoK4odwgZXV1QlOcYuX4FU0lfly/Vqvprqke9TJyrT/N6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.289.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dJNZP3UkoBawrrVryfiQ4zVNuiZoHx8PBvYHdSUZnVRoT+/Dd+i1dFqgCBig8ohl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.478.0/index.min.mjs": "sha384-dJNZP3UkoBawrrVryfiQ4zVNuiZoHx8PBvYHdSUZnVRoT+/Dd+i1dFqgCBig8ohl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.478.0/LICENSE
```

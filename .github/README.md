...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.342.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.342.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-buUOi/NgROtzT0Lh4vChS7MGQWDKKzswF+AAjjsyqk5SC/w8Qb2RZFcr8/oswAJH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.342.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.342.0/index.min.mjs": "sha384-buUOi/NgROtzT0Lh4vChS7MGQWDKKzswF+AAjjsyqk5SC/w8Qb2RZFcr8/oswAJH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.342.0/LICENSE
```

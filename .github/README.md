...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.468.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.468.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RZE/gKSbEhTxhPyIRpc/85XIt1jHz4YiGCbXm+kAJ++jnbfqC5A9C5nUbcyCyClg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.468.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.468.0/index.min.mjs": "sha384-RZE/gKSbEhTxhPyIRpc/85XIt1jHz4YiGCbXm+kAJ++jnbfqC5A9C5nUbcyCyClg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.468.0/LICENSE
```

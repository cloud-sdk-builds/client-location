...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.197.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.197.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NNXTYvp1Mip5lf5PpLoe1bO2iNhfEA5u61SPNAHDRChhYGGIXENvsS74v0iGEYEn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.197.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.197.0/index.min.mjs": "sha384-NNXTYvp1Mip5lf5PpLoe1bO2iNhfEA5u61SPNAHDRChhYGGIXENvsS74v0iGEYEn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.197.0/LICENSE
```

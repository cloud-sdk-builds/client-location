...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.309.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.309.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LvO8q9taGrKx4u3L7YU3HmhGixxJq43rJLd/0+AlrIyxBJQpoLiSRJidpA5uYbqT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.309.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.309.0/index.min.mjs": "sha384-LvO8q9taGrKx4u3L7YU3HmhGixxJq43rJLd/0+AlrIyxBJQpoLiSRJidpA5uYbqT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.309.0/LICENSE
```

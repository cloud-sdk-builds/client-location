...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CcTqPMyZeY02NTOM7QKSRFwdPm0ET8ik4jdbw1JCBFsHjsO46G5teCvKMsbYV/dD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.670.0/index.min.mjs": "sha384-CcTqPMyZeY02NTOM7QKSRFwdPm0ET8ik4jdbw1JCBFsHjsO46G5teCvKMsbYV/dD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.670.0/LICENSE
```

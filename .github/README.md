...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1016.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1016.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uoQDMusPAS6JRAWkVPbPM1VhGNTy76ITXV9468MQ7wgi1dW1i0N+dKVI9AZElqEU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1016.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1016.0/index.min.mjs": "sha384-uoQDMusPAS6JRAWkVPbPM1VhGNTy76ITXV9468MQ7wgi1dW1i0N+dKVI9AZElqEU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1016.0/LICENSE
```

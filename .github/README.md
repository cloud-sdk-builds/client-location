...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tMyZeMbuW9rBvyw3hRDWcp0LZVWButMm6kOjMNtWP0vakEfZ10j13qtfua/kwPGw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.987.0/index.min.mjs": "sha384-tMyZeMbuW9rBvyw3hRDWcp0LZVWButMm6kOjMNtWP0vakEfZ10j13qtfua/kwPGw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.987.0/LICENSE
```

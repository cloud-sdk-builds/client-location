...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gTqVYLQivWsYy8CkSHL4ibUeXx/i4N+NsOT9AKy/7xOaAUwfxgfo1oTCZtJeAqcx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.916.0/index.min.mjs": "sha384-gTqVYLQivWsYy8CkSHL4ibUeXx/i4N+NsOT9AKy/7xOaAUwfxgfo1oTCZtJeAqcx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.916.0/LICENSE
```

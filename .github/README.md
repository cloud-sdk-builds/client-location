...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.569.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.569.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BzrzdsKgEhmWl67HnaJnBsnKWh7RlWBCADRT50JdQK3EvrExF3USQdmQ+0d/FIHe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.569.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.569.0/index.min.mjs": "sha384-BzrzdsKgEhmWl67HnaJnBsnKWh7RlWBCADRT50JdQK3EvrExF3USQdmQ+0d/FIHe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.569.0/LICENSE
```

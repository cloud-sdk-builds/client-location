...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1036.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1036.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iBlcr44KeZk3JgwnOJRWSCc6FN3OZq3HyDzQXrp9LI/su0oikIq/iRc/LWpyPD4N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1036.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1036.0/index.min.mjs": "sha384-iBlcr44KeZk3JgwnOJRWSCc6FN3OZq3HyDzQXrp9LI/su0oikIq/iRc/LWpyPD4N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1036.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PHLm8TM10BmiLvbFJYeWrGyquwhS8P3Z+kV49apDIGRW3SR7REgWWElyARN0Io66
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.264.0/index.min.mjs": "sha384-PHLm8TM10BmiLvbFJYeWrGyquwhS8P3Z+kV49apDIGRW3SR7REgWWElyARN0Io66"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.264.0/LICENSE
```

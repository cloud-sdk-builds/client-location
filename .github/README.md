...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wYsqVRJSiO9L8zbHb7EjGaLlzsxk3gJFVcxeNOMwTjPeZrdlHokHcgkSKN+K550K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.632.0/index.min.mjs": "sha384-wYsqVRJSiO9L8zbHb7EjGaLlzsxk3gJFVcxeNOMwTjPeZrdlHokHcgkSKN+K550K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.632.0/LICENSE
```

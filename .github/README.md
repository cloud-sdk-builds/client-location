...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.121.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aXDYwzwf2iKMRMy62hZqzI2t6Ejv6JH2Uy8PPzswcdu0a4RPccN2SrIFHilTDSrN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.121.0/index.min.mjs": "sha384-aXDYwzwf2iKMRMy62hZqzI2t6Ejv6JH2Uy8PPzswcdu0a4RPccN2SrIFHilTDSrN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.121.0/LICENSE
```

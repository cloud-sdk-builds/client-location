...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JSbI8JBoc7ekWNBNDk3GOoT9w1FLE+nPAUsWSCiJUTRORfrhbE96mGf+cdQOdu7M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.423.0/index.min.mjs": "sha384-JSbI8JBoc7ekWNBNDk3GOoT9w1FLE+nPAUsWSCiJUTRORfrhbE96mGf+cdQOdu7M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.423.0/LICENSE
```

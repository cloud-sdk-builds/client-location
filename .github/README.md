...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.162.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.162.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DcWbswYwX0Q0//KCl7SXQF5eNDfvR8YKUsvneiyHX3AeF8pvBaLnkc5VxP3JIuki
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.162.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.162.0/index.min.mjs": "sha384-DcWbswYwX0Q0//KCl7SXQF5eNDfvR8YKUsvneiyHX3AeF8pvBaLnkc5VxP3JIuki"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.162.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yfxe39xkBVGzXcxB5mlsVWdQDmNo+O98YhZwdCni1i6W2zc7PaYDRT2YbihElDxT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.310.0/index.min.mjs": "sha384-yfxe39xkBVGzXcxB5mlsVWdQDmNo+O98YhZwdCni1i6W2zc7PaYDRT2YbihElDxT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.310.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IIEoWnJKLdSiYNL78ZQ4/DMTQlbfCoVRudTq5KBnthxlnocv6zxly5R01bpsYqtg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.863.0/index.min.mjs": "sha384-IIEoWnJKLdSiYNL78ZQ4/DMTQlbfCoVRudTq5KBnthxlnocv6zxly5R01bpsYqtg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.863.0/LICENSE
```

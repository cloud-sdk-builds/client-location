...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iHalVnh3r1s5Ji6DIkun+bls0IrS/7MJ9b9fksZF4a4wSB+BdUYtv0g2q/5yjvWo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.799.0/index.min.mjs": "sha384-iHalVnh3r1s5Ji6DIkun+bls0IrS/7MJ9b9fksZF4a4wSB+BdUYtv0g2q/5yjvWo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.799.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BnZTZCrjbvomIyKxwzheqG6QYaac4gLjjWqaOT20sMHuh6DAAbHo9vePYLFstDfg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.682.0/index.min.mjs": "sha384-BnZTZCrjbvomIyKxwzheqG6QYaac4gLjjWqaOT20sMHuh6DAAbHo9vePYLFstDfg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.682.0/LICENSE
```

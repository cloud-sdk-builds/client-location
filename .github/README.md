...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.357.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.357.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8FJQLMTIFeaj6bHrIIGDcGexkLb9gEjPJA/qbs+ZJEVFOczMC3FVFjMFT/bP0RMh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.357.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.357.0/index.min.mjs": "sha384-8FJQLMTIFeaj6bHrIIGDcGexkLb9gEjPJA/qbs+ZJEVFOczMC3FVFjMFT/bP0RMh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.357.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.797.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.797.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jmqjj6Um3DQwXEfaprTs0oO8Lvcwie4oz3lCYSuRk/5ROxjCeNBXpaQP/xEj+X4W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.797.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.797.0/index.min.mjs": "sha384-jmqjj6Um3DQwXEfaprTs0oO8Lvcwie4oz3lCYSuRk/5ROxjCeNBXpaQP/xEj+X4W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.797.0/LICENSE
```

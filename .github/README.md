...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qbBb2BItiFYyeO1TyhfosMF5NamPXV4W2DBBG3c5J+hNGvGLSj7LUfAmut7cA3fg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.906.0/index.min.mjs": "sha384-qbBb2BItiFYyeO1TyhfosMF5NamPXV4W2DBBG3c5J+hNGvGLSj7LUfAmut7cA3fg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.906.0/LICENSE
```

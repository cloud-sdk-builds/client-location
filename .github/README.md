...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.367.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.367.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UCS+VOB2jt9MYkwvnxxf6Zl2Ay56va3zl3bGR95pg6o2z7tcxkdN1mIcbojlWkl0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.367.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.367.0/index.min.mjs": "sha384-UCS+VOB2jt9MYkwvnxxf6Zl2Ay56va3zl3bGR95pg6o2z7tcxkdN1mIcbojlWkl0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.367.0/LICENSE
```

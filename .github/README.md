...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2a86Rz0fxbkWLd3Y53PykLKcWGKwm/iN1JnatTCmLWpWmbTiMu+gVyH7A/lkg2Xy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.185.0/index.min.mjs": "sha384-2a86Rz0fxbkWLd3Y53PykLKcWGKwm/iN1JnatTCmLWpWmbTiMu+gVyH7A/lkg2Xy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.185.0/LICENSE
```

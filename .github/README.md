...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.204.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.204.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QCFKts8Zn4EdRDtph+Q9nGGtrVoCo+w0X4OFTcCxSoE4DEl1x27qOZSE+0fmXu5U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.204.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.204.0/index.min.mjs": "sha384-QCFKts8Zn4EdRDtph+Q9nGGtrVoCo+w0X4OFTcCxSoE4DEl1x27qOZSE+0fmXu5U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.204.0/LICENSE
```

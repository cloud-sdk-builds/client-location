...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.67.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.67.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0MZriGXs3OWjG7zzYbgXpFZ48UlFRk7TT8vFLxat+kdNoVaZmSteKN/G3tMW6stQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.67.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.67.0/index.min.mjs": "sha384-0MZriGXs3OWjG7zzYbgXpFZ48UlFRk7TT8vFLxat+kdNoVaZmSteKN/G3tMW6stQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.67.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gEdKhhd6rISjItERumV7Gwm4BJ5Gd+3UaRWE9P28lTethtRwpi8Z3bBp6AQCyMag
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.154.0/index.min.mjs": "sha384-gEdKhhd6rISjItERumV7Gwm4BJ5Gd+3UaRWE9P28lTethtRwpi8Z3bBp6AQCyMag"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.154.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ueVb/1mFfZ61yVV/6xIL6QrChdyDDcVPsBC3jUV0cGgFw3szqNxoWSUGhaCOeG4t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.252.0/index.min.mjs": "sha384-ueVb/1mFfZ61yVV/6xIL6QrChdyDDcVPsBC3jUV0cGgFw3szqNxoWSUGhaCOeG4t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.252.0/LICENSE
```

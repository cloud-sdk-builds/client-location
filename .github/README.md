...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ewc2I7KpZzcllwRDLsyllu0cKREGyHEdrS9Tajd4jZIvRdGzbK1xAKucDyp3Z29I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.315.0/index.min.mjs": "sha384-Ewc2I7KpZzcllwRDLsyllu0cKREGyHEdrS9Tajd4jZIvRdGzbK1xAKucDyp3Z29I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.315.0/LICENSE
```

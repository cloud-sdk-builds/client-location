...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.472.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.472.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zlvCVeLrHC0lXyhuoXGirh/dCpzvLj5YzRXt+L/YuG2FgllMBGvC1nukrC+vmw/S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.472.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.472.0/index.min.mjs": "sha384-zlvCVeLrHC0lXyhuoXGirh/dCpzvLj5YzRXt+L/YuG2FgllMBGvC1nukrC+vmw/S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.472.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jYUKN0dK3RYhKr0eEAWg//ZyfkKYJHwfkajbFmCA4zjVPvrF7RgqifFcipYBLWdC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.476.0/index.min.mjs": "sha384-jYUKN0dK3RYhKr0eEAWg//ZyfkKYJHwfkajbFmCA4zjVPvrF7RgqifFcipYBLWdC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.476.0/LICENSE
```

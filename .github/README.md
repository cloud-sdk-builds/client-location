...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c+i2uAXKCfEs1hTj1Wqe8TVgkJtMeuscjq/jOghG4fHmIPP6S6RgZLUM4/myaRCM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.899.0/index.min.mjs": "sha384-c+i2uAXKCfEs1hTj1Wqe8TVgkJtMeuscjq/jOghG4fHmIPP6S6RgZLUM4/myaRCM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.899.0/LICENSE
```

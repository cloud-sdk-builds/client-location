...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.194.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.194.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hSrEMNOFu+lqGdqTYKZAlN9DxUgd+zhKMDPJy8fpcpqx6+kYnjzIbu762gM01tls
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.194.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.194.0/index.min.mjs": "sha384-hSrEMNOFu+lqGdqTYKZAlN9DxUgd+zhKMDPJy8fpcpqx6+kYnjzIbu762gM01tls"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.194.0/LICENSE
```

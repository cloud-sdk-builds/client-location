...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.927.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.927.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PJWiG7sqEzm0m/eK47IQrOhfTQmesstnfAMEt3hQG4L/mq/24yfcbAMFSw5Om3gx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.927.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.927.0/index.min.mjs": "sha384-PJWiG7sqEzm0m/eK47IQrOhfTQmesstnfAMEt3hQG4L/mq/24yfcbAMFSw5Om3gx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.927.0/LICENSE
```

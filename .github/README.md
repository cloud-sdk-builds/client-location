...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bH5OkknNhwdtyemHUJtNCjO33inwrqDuI2Uo1dqGmzlE9X04kzRQvqvVjICLKA1H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.723.0/index.min.mjs": "sha384-bH5OkknNhwdtyemHUJtNCjO33inwrqDuI2Uo1dqGmzlE9X04kzRQvqvVjICLKA1H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.723.0/LICENSE
```

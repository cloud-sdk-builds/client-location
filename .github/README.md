...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YNfBxtJAnd2rAZoNEoQHNvWAG4lR3dYGXMGjkmCAZY2it1/AKnqwruoffjqOFjIq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.726.0/index.min.mjs": "sha384-YNfBxtJAnd2rAZoNEoQHNvWAG4lR3dYGXMGjkmCAZY2it1/AKnqwruoffjqOFjIq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.726.0/LICENSE
```

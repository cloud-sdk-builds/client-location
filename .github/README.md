...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RLMch7Ku53btOofnNuYnOhNahdIceXLYIB4Xfg6UDSO6Vp5JweCLIY9A2IBxsY8/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.235.0/index.min.mjs": "sha384-RLMch7Ku53btOofnNuYnOhNahdIceXLYIB4Xfg6UDSO6Vp5JweCLIY9A2IBxsY8/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.235.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.236.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.236.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LY47VH9vMwnzw3UR5zLgPmBMOXTMr+0SaqRXennsGDTlTvIvtefRyH6bbeRsFwkf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.236.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.236.0/index.min.mjs": "sha384-LY47VH9vMwnzw3UR5zLgPmBMOXTMr+0SaqRXennsGDTlTvIvtefRyH6bbeRsFwkf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.236.0/LICENSE
```

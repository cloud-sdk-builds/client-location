...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.232.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.232.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V9MeUP2sYhs8e/mUn7X/v89WhgDsuEs96lP48UhKjmaa2nwwOvBin6PtUeKBINCa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.232.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.232.0/index.min.mjs": "sha384-V9MeUP2sYhs8e/mUn7X/v89WhgDsuEs96lP48UhKjmaa2nwwOvBin6PtUeKBINCa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.232.0/LICENSE
```

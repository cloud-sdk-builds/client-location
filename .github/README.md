...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TsL/4321aoT9DyVNkC0dMK3nrrtRBbJ1MNRY05nyyMxyVD7jQu6iD8uPxjwQyFY7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.890.0/index.min.mjs": "sha384-TsL/4321aoT9DyVNkC0dMK3nrrtRBbJ1MNRY05nyyMxyVD7jQu6iD8uPxjwQyFY7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.890.0/LICENSE
```

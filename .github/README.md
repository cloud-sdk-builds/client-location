...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.806.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.806.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zPKIJCNrjYuOpjbRA8GG0/I6P5gjpUkkNYxCORmRMMG4SrLru+CKPpNW05I6Lcgy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.806.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.806.0/index.min.mjs": "sha384-zPKIJCNrjYuOpjbRA8GG0/I6P5gjpUkkNYxCORmRMMG4SrLru+CKPpNW05I6Lcgy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.806.0/LICENSE
```

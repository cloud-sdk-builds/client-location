...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AJaJW8y/yQRBFOPDz9cFIetpp9DKHm7cGJbdySD2Im0kPM8/1DNeCPksTp/QGuiy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.943.0/index.min.mjs": "sha384-AJaJW8y/yQRBFOPDz9cFIetpp9DKHm7cGJbdySD2Im0kPM8/1DNeCPksTp/QGuiy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.943.0/LICENSE
```

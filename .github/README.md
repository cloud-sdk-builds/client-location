...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ertyq+kA0e9BKTjca3uPK7fsyKLj7HhPGhEwQ8OvFfEYo6mIFRqvz5FAe9ot3Xw2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.859.0/index.min.mjs": "sha384-Ertyq+kA0e9BKTjca3uPK7fsyKLj7HhPGhEwQ8OvFfEYo6mIFRqvz5FAe9ot3Xw2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.859.0/LICENSE
```

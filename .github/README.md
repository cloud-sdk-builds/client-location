...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.429.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.429.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xRf/fd7ceRIo97opjrZwlmzNVQNcG/sovSg80wmcYee0E13U2XSQB8odjRLNpb3Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.429.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.429.0/index.min.mjs": "sha384-xRf/fd7ceRIo97opjrZwlmzNVQNcG/sovSg80wmcYee0E13U2XSQB8odjRLNpb3Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.429.0/LICENSE
```

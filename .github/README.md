...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.352.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.352.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1lPOv8BVITgbfr86ADRVb9p7jEVMU1BW+Cyfy74AKz2V8Z4prFFfVtDGYoO/+yYF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.352.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.352.0/index.min.mjs": "sha384-1lPOv8BVITgbfr86ADRVb9p7jEVMU1BW+Cyfy74AKz2V8Z4prFFfVtDGYoO/+yYF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.352.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7za3ooqarWy2GMcfoDjepGy161N//5H+ZDXsmsGU4Y6FXnSooctggn+IQySGLp7v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.808.0/index.min.mjs": "sha384-7za3ooqarWy2GMcfoDjepGy161N//5H+ZDXsmsGU4Y6FXnSooctggn+IQySGLp7v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.808.0/LICENSE
```

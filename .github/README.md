...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e7gmFWjDr0vo3ZTbjm2ndw4MBkyqd3GxJJ18PYmf7Vo9lVCix2acJz/VEu2bQJa6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.975.0/index.min.mjs": "sha384-e7gmFWjDr0vo3ZTbjm2ndw4MBkyqd3GxJJ18PYmf7Vo9lVCix2acJz/VEu2bQJa6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.975.0/LICENSE
```

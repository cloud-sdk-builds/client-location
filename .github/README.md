...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L1lEwNUuGU4ULUlhavYX+/yFme76TCjhM9GqwPPwZl/8jmY4vACiFhN/pTpBt8PO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.812.0/index.min.mjs": "sha384-L1lEwNUuGU4ULUlhavYX+/yFme76TCjhM9GqwPPwZl/8jmY4vACiFhN/pTpBt8PO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.812.0/LICENSE
```

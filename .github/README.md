...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KyKRNoq0k6kxrOB5OEKRtZyGzxHzr722scvL1u4VpECNUKd0cIQxMmK+s5z9YGpE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.290.0/index.min.mjs": "sha384-KyKRNoq0k6kxrOB5OEKRtZyGzxHzr722scvL1u4VpECNUKd0cIQxMmK+s5z9YGpE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.290.0/LICENSE
```

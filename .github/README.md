...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.181.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.181.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AOLRAchBHCbmpHS9SrlWNqNrP36nCa2QtsDfF/S70i8Lh8Cpys3CDrAN07XWDWfq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.181.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.181.0/index.min.mjs": "sha384-AOLRAchBHCbmpHS9SrlWNqNrP36nCa2QtsDfF/S70i8Lh8Cpys3CDrAN07XWDWfq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.181.0/LICENSE
```

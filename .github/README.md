...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.180.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.180.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VEgY4yIvKbXpfxQQEKsfIGyAj8b4f5TuAbRddEuV/NaJfm8iaOSOe1eW00CTMY5j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.180.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.180.0/index.min.mjs": "sha384-VEgY4yIvKbXpfxQQEKsfIGyAj8b4f5TuAbRddEuV/NaJfm8iaOSOe1eW00CTMY5j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.180.0/LICENSE
```

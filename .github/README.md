...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RodDTmU0GoKXXCn2J0Ysgwaxb29QUf3azVWb6qsSHo+qeUqDHmBVZlXMoDYkFU89
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.460.0/index.min.mjs": "sha384-RodDTmU0GoKXXCn2J0Ysgwaxb29QUf3azVWb6qsSHo+qeUqDHmBVZlXMoDYkFU89"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.460.0/LICENSE
```

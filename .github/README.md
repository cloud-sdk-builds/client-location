...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.533.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.533.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-poSyegZf4K4uC0A6mHbJAPymqH4/jZbam7rzSZGdzqmIoZgcdY7/onJYKHVERIRa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.533.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.533.0/index.min.mjs": "sha384-poSyegZf4K4uC0A6mHbJAPymqH4/jZbam7rzSZGdzqmIoZgcdY7/onJYKHVERIRa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.533.0/LICENSE
```

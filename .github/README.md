...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N1p5VzcVSG7QTcl77w+uSFwkeXe+1S0tTGZMan0adLu0m19P9gsyjXpriX4xBEsm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.326.0/index.min.mjs": "sha384-N1p5VzcVSG7QTcl77w+uSFwkeXe+1S0tTGZMan0adLu0m19P9gsyjXpriX4xBEsm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.326.0/LICENSE
```

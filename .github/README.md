...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ucQ/5XkQackTCecW8BWW0mvc9FU0S/bSfGE+H+96ZvO1GkoD/Z6cr9remA+Opmjf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.855.0/index.min.mjs": "sha384-ucQ/5XkQackTCecW8BWW0mvc9FU0S/bSfGE+H+96ZvO1GkoD/Z6cr9remA+Opmjf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.855.0/LICENSE
```

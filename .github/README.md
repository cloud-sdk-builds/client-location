...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mAEeiQCPcHA2IqXc/3MM0tBbQuMDDucfBVuV1pVVpagg9yYroCPpL6esMgiDgTBV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.259.0/index.min.mjs": "sha384-mAEeiQCPcHA2IqXc/3MM0tBbQuMDDucfBVuV1pVVpagg9yYroCPpL6esMgiDgTBV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.259.0/LICENSE
```

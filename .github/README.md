...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1008.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1008.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wCaWBZSi0HhIzjiaERr9T6kISNlgrPPsSysFnlACFbSvYqeLuAI0mugVkN9QQ2up
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1008.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1008.0/index.min.mjs": "sha384-wCaWBZSi0HhIzjiaERr9T6kISNlgrPPsSysFnlACFbSvYqeLuAI0mugVkN9QQ2up"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1008.0/LICENSE
```

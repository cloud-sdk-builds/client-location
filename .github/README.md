...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZsonotjDw37Xig+sEoFCjsravz+js+nKg4FwssXDscZ33vn/0KDBn2mxgqlIN7R9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.995.0/index.min.mjs": "sha384-ZsonotjDw37Xig+sEoFCjsravz+js+nKg4FwssXDscZ33vn/0KDBn2mxgqlIN7R9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.995.0/LICENSE
```

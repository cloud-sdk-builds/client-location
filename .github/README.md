...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RC6GMJ5QQ5cK69dMG0+Zb2eOVhHR3+4QLQFXeHV7kPEw4i8oPLhFYaO7lyt7oOic
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.828.0/index.min.mjs": "sha384-RC6GMJ5QQ5cK69dMG0+Zb2eOVhHR3+4QLQFXeHV7kPEw4i8oPLhFYaO7lyt7oOic"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.828.0/LICENSE
```

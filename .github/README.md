...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1030.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1030.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e1r7/hj7Sk74+NljndGWu8y7qHXGIMklGHF8QxFghGHUpL6fuYGxom5ayztdq/4H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1030.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1030.0/index.min.mjs": "sha384-e1r7/hj7Sk74+NljndGWu8y7qHXGIMklGHF8QxFghGHUpL6fuYGxom5ayztdq/4H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1030.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IBwUpqJuKysOjiV6iXZFGXcApsc1yW9U+AK0FMRGEyybN4s+RhKbYGhiWzLWi9de
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.128.0/index.min.mjs": "sha384-IBwUpqJuKysOjiV6iXZFGXcApsc1yW9U+AK0FMRGEyybN4s+RhKbYGhiWzLWi9de"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.128.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WKXcu8tC/v2YFKByg/lRa4X0gg3qpe5Gbhp0wkALhKgDwSeL4FOi3BbJy6CBXfs/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.777.0/index.min.mjs": "sha384-WKXcu8tC/v2YFKByg/lRa4X0gg3qpe5Gbhp0wkALhKgDwSeL4FOi3BbJy6CBXfs/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.777.0/LICENSE
```

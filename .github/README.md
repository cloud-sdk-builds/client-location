...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fcjdjNl7XA9n2BmSOxzgSl/gUGjmOMez2xAy+4flnvWH+e3SldhqMtlBRblKpN3x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.731.0/index.min.mjs": "sha384-fcjdjNl7XA9n2BmSOxzgSl/gUGjmOMez2xAy+4flnvWH+e3SldhqMtlBRblKpN3x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.731.0/LICENSE
```

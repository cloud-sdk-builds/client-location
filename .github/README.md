...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.266.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.266.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AhblBh7cP/gue5pq/d9sCBMvNP/CQpjB8hY+PVw3C4zLPQJlvaD81xiV4VKzTLHf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.266.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.266.0/index.min.mjs": "sha384-AhblBh7cP/gue5pq/d9sCBMvNP/CQpjB8hY+PVw3C4zLPQJlvaD81xiV4VKzTLHf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.266.0/LICENSE
```

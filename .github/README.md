...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q5+0OZbcaKaYeb8nsN8UogyYl1PisXdZDoa6/HJSj2wS/57dnYbmcp8PKrlMuFv4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.414.0/index.min.mjs": "sha384-Q5+0OZbcaKaYeb8nsN8UogyYl1PisXdZDoa6/HJSj2wS/57dnYbmcp8PKrlMuFv4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.414.0/LICENSE
```

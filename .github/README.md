...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0uuuPPmlMUpPvy+oge61ZUHTOl/W13y31k3dCgUYLg6WCzFkLDROIs03E3WpIPC2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.844.0/index.min.mjs": "sha384-0uuuPPmlMUpPvy+oge61ZUHTOl/W13y31k3dCgUYLg6WCzFkLDROIs03E3WpIPC2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.844.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G/X4plB1Xd3QzdYLqlt7JGEVmpH9oljj37k6oVJxduR/UKou2YIe1KSDtKXW8g+W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.966.0/index.min.mjs": "sha384-G/X4plB1Xd3QzdYLqlt7JGEVmpH9oljj37k6oVJxduR/UKou2YIe1KSDtKXW8g+W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.966.0/LICENSE
```

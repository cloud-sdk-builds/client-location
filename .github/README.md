...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.540.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.540.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NKn1HXViaKhvJU13HD364/A0+OcMJIlw27b1L6XKWhgYrVaWsN8NGHHLNhE7xnde
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.540.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.540.0/index.min.mjs": "sha384-NKn1HXViaKhvJU13HD364/A0+OcMJIlw27b1L6XKWhgYrVaWsN8NGHHLNhE7xnde"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.540.0/LICENSE
```

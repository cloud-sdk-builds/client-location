...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1041.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1041.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QSDu+muVwsyKc0zQQQYsba7BaE+3WmFogJLzcDFTYTXh9PRS5tJwWNhdUtnHw0DK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1041.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1041.0/index.min.mjs": "sha384-QSDu+muVwsyKc0zQQQYsba7BaE+3WmFogJLzcDFTYTXh9PRS5tJwWNhdUtnHw0DK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1041.0/LICENSE
```

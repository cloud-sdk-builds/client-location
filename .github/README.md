...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.1000.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1000.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EZlIC41N9Pvs8Fov0Y5gf74mp1o4jGukO+huU5oWfyNa+UiF4O0LdlGpiXwutONl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1000.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.1000.0/index.min.mjs": "sha384-EZlIC41N9Pvs8Fov0Y5gf74mp1o4jGukO+huU5oWfyNa+UiF4O0LdlGpiXwutONl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.1000.0/LICENSE
```

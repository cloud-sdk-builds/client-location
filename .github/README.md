...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.347.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.347.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OIfkUGW4U+ngqOqEmTdS8Fw5XMbSysvPFHTt/CkL3w8N5mwyqYXh4W2WwNBxRS6P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.347.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.347.0/index.min.mjs": "sha384-OIfkUGW4U+ngqOqEmTdS8Fw5XMbSysvPFHTt/CkL3w8N5mwyqYXh4W2WwNBxRS6P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.347.0/LICENSE
```

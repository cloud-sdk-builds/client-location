...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LN7GEot1fIroFvxmHCqNkL3yvLLYdOxBXbdcoPG6TVTfGQpoxhyB/0cvIkJdopnb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.72.0/index.min.mjs": "sha384-LN7GEot1fIroFvxmHCqNkL3yvLLYdOxBXbdcoPG6TVTfGQpoxhyB/0cvIkJdopnb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.72.0/LICENSE
```

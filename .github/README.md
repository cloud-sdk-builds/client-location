...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.61.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.61.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rx5VQDYh3XEekUa5QhTblh/rsgYyeMMrC5eMcouWKXmILTtx5UbKYV0kj5RAhtYo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.61.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.61.0/index.min.mjs": "sha384-Rx5VQDYh3XEekUa5QhTblh/rsgYyeMMrC5eMcouWKXmILTtx5UbKYV0kj5RAhtYo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.61.0/LICENSE
```

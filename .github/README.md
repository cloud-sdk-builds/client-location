...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qKix2c+3gaJU+j04gWSwuIO+iNj+zQAGY7U2zoG+huLKYdfshlkSrLANRjAkoPn3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.772.0/index.min.mjs": "sha384-qKix2c+3gaJU+j04gWSwuIO+iNj+zQAGY7U2zoG+huLKYdfshlkSrLANRjAkoPn3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.772.0/LICENSE
```

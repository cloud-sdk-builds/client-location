...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.556.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.556.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hq1jtJxqaexy/QMkghq15URJ6ATXtlE+jKFBSLWTbg3WGdFklOiaD6vfHm8ETEzu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.556.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.556.0/index.min.mjs": "sha384-hq1jtJxqaexy/QMkghq15URJ6ATXtlE+jKFBSLWTbg3WGdFklOiaD6vfHm8ETEzu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.556.0/LICENSE
```

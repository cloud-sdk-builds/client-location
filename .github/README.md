...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h5bcdK8LR4S/Sc9G5qctX86Pf4bwYCTkErISLKrioO5mKEQIFThMi5N2+Q56jnjT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.582.0/index.min.mjs": "sha384-h5bcdK8LR4S/Sc9G5qctX86Pf4bwYCTkErISLKrioO5mKEQIFThMi5N2+Q56jnjT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.582.0/LICENSE
```

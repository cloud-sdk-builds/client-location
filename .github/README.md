...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wgpZMDPM/YihQrTirJtO2VjaiNkTUD6c6j2DRYUUBxUbI0y6bj3vLB26f02IM+i6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.388.0/index.min.mjs": "sha384-wgpZMDPM/YihQrTirJtO2VjaiNkTUD6c6j2DRYUUBxUbI0y6bj3vLB26f02IM+i6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.388.0/LICENSE
```

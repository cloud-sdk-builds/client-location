...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T124FDxfdejMnWVXrK+GSrOWUxfa63JrY+F5+bcC3F05+5ax6EftU8eSfu4h+ZWH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.17.0/index.min.mjs": "sha384-T124FDxfdejMnWVXrK+GSrOWUxfa63JrY+F5+bcC3F05+5ax6EftU8eSfu4h+ZWH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.17.0/LICENSE
```

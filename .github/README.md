...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I+D4FkFg8obz94pPi8daez2iYiyym76p4q7omNc4nFiMxmrTHI3L27JxHDn+No7r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.312.0/index.min.mjs": "sha384-I+D4FkFg8obz94pPi8daez2iYiyym76p4q7omNc4nFiMxmrTHI3L27JxHDn+No7r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.312.0/LICENSE
```

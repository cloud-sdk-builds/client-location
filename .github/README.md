...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.678.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.678.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qgjQb6HYENcYsz2pqDtdF1FqjZulxNjvU0uJTGDeZO2TSqIFFxRgp99IQ/WkmCpD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.678.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.678.0/index.min.mjs": "sha384-qgjQb6HYENcYsz2pqDtdF1FqjZulxNjvU0uJTGDeZO2TSqIFFxRgp99IQ/WkmCpD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.678.0/LICENSE
```

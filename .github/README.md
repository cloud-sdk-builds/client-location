...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3lWFOpWVN27Ch60ShAbRBT3eHUX7YCbNgVHU8QtuBnonV+rDJCZZQ1Wy17iL1lZj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.370.0/index.min.mjs": "sha384-3lWFOpWVN27Ch60ShAbRBT3eHUX7YCbNgVHU8QtuBnonV+rDJCZZQ1Wy17iL1lZj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.370.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.303.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.303.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qzkozR3yIrhy+RK2cgXWUv8W/fXxPuin6b8bylBLT17gT637vjZPf28tZChQxXVS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.303.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.303.0/index.min.mjs": "sha384-qzkozR3yIrhy+RK2cgXWUv8W/fXxPuin6b8bylBLT17gT637vjZPf28tZChQxXVS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.303.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6nY0uAQM0kT6sTx+vhtN0gYiCRLUnnK8TNQXA4zpk4lf8sQQ7gjGBzLZbq/8TeYr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.413.0/index.min.mjs": "sha384-6nY0uAQM0kT6sTx+vhtN0gYiCRLUnnK8TNQXA4zpk4lf8sQQ7gjGBzLZbq/8TeYr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.413.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0jUAYmfvSQ/u6v1JDm4+/FYs+e5GbFm3cV+/KoST6oly2zeAJXI2czbI4aYdfBGv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.179.0/index.min.mjs": "sha384-0jUAYmfvSQ/u6v1JDm4+/FYs+e5GbFm3cV+/KoST6oly2zeAJXI2czbI4aYdfBGv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.179.0/LICENSE
```

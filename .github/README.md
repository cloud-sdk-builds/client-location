...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-7BoKCXgnaGgZUVJFgb0ETVk9CnRQ9DDZy1C0TExtT94fY/FGZZgJMfxDg08BJt5o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.347.1/index.min.mjs": "sha384-7BoKCXgnaGgZUVJFgb0ETVk9CnRQ9DDZy1C0TExtT94fY/FGZZgJMfxDg08BJt5o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.347.1/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ish9OF2E+rC3RLb0djYU7KPIDfD1sbZUdguvaMjt1l0Fjs3LA2Pax3QgTv7dha40
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.738.0/index.min.mjs": "sha384-Ish9OF2E+rC3RLb0djYU7KPIDfD1sbZUdguvaMjt1l0Fjs3LA2Pax3QgTv7dha40"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.738.0/LICENSE
```

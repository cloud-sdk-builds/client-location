...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rXlK1BlGk0GqmhlyTjMA6QwrlFEHY5vj49nV5HUSTSW9Rg0Rqc0/CBpihu+5uWZO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.19.0/index.min.mjs": "sha384-rXlK1BlGk0GqmhlyTjMA6QwrlFEHY5vj49nV5HUSTSW9Rg0Rqc0/CBpihu+5uWZO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.19.0/LICENSE
```

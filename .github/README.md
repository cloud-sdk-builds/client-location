...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L+kx8dIiV8mV4mSNCQ4YB+EL21yn071wA9IqRj95f5EOrp8yy5eaumY10B4wCnJ0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.596.0/index.min.mjs": "sha384-L+kx8dIiV8mV4mSNCQ4YB+EL21yn071wA9IqRj95f5EOrp8yy5eaumY10B4wCnJ0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.596.0/LICENSE
```

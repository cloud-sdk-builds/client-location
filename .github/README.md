...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oOx69MsYjG1RzPDPRrdLeTFyRDRnzf0aqMLCy/020b/70pfC/Zrmg5y2KarHPik7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.15.0/index.min.mjs": "sha384-oOx69MsYjG1RzPDPRrdLeTFyRDRnzf0aqMLCy/020b/70pfC/Zrmg5y2KarHPik7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.15.0/LICENSE
```

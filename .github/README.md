...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.210.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.210.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yp3K4qbfC/OBrpbF7Geo8tfv2789ipAXJpZc4l048b1d2M1h/EQgCPKpXbaoZMcH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.210.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.210.0/index.min.mjs": "sha384-yp3K4qbfC/OBrpbF7Geo8tfv2789ipAXJpZc4l048b1d2M1h/EQgCPKpXbaoZMcH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.210.0/LICENSE
```

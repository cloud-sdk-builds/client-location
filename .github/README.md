...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t+lEEftbtySZ5DE5JokbYK/hXuTvdwY8XIpPpDf/MbV/E9V31deqSC6ZayHVLCvo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.592.0/index.min.mjs": "sha384-t+lEEftbtySZ5DE5JokbYK/hXuTvdwY8XIpPpDf/MbV/E9V31deqSC6ZayHVLCvo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.592.0/LICENSE
```

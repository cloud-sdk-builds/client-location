...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.922.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.922.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wkTeXdXjt/OVVYfVIVqCc5mJINjiiXGQLHwbGdm0+Ub4KmOLFa1GLNMsQT2Bf+ez
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.922.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.922.0/index.min.mjs": "sha384-wkTeXdXjt/OVVYfVIVqCc5mJINjiiXGQLHwbGdm0+Ub4KmOLFa1GLNMsQT2Bf+ez"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.922.0/LICENSE
```

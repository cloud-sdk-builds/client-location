...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XZmsx/O99J3FOMJozOnlwaMVK74TYwDaz7zV+kYRUFX0YaDPn95UVfkd0+WewR2A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.933.0/index.min.mjs": "sha384-XZmsx/O99J3FOMJozOnlwaMVK74TYwDaz7zV+kYRUFX0YaDPn95UVfkd0+WewR2A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.933.0/LICENSE
```

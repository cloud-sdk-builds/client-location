...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v2qYSUlpzlKyx1M0d5sZ3BcPnI6y8IvBFkmNI3LZgk58Y6MmFpvNHkqwCxpG2YvN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.623.0/index.min.mjs": "sha384-v2qYSUlpzlKyx1M0d5sZ3BcPnI6y8IvBFkmNI3LZgk58Y6MmFpvNHkqwCxpG2YvN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.623.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PrsO8UYlhFCAEYlZ7+XIx7sYJLw6fV59UK/9qD2lCR2iApzYKBZAMIUqIRSSW2HN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.55.0/index.min.mjs": "sha384-PrsO8UYlhFCAEYlZ7+XIx7sYJLw6fV59UK/9qD2lCR2iApzYKBZAMIUqIRSSW2HN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.55.0/LICENSE
```

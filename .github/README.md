...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.857.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.857.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Uw0vWuPNVKrJRTR2pQuBpZiV9WLtRXekLsegqRCjjyJXbT9nC/SSxXz51tf72wXT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.857.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.857.0/index.min.mjs": "sha384-Uw0vWuPNVKrJRTR2pQuBpZiV9WLtRXekLsegqRCjjyJXbT9nC/SSxXz51tf72wXT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.857.0/LICENSE
```

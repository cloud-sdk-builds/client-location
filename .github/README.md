...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZcffvLxDMZ+eW0yUG38sz+//24S7uWVfKKw6gu6htnwe3S1K9MUyL8GvHjlr6F1m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.435.0/index.min.mjs": "sha384-ZcffvLxDMZ+eW0yUG38sz+//24S7uWVfKKw6gu6htnwe3S1K9MUyL8GvHjlr6F1m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.435.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7CdpKtlU9qqv1M9liNTwQUcm4BhP3UQ1TtGGe8o76O9wBee0WjGESRnkQ+3S5aR7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.535.0/index.min.mjs": "sha384-7CdpKtlU9qqv1M9liNTwQUcm4BhP3UQ1TtGGe8o76O9wBee0WjGESRnkQ+3S5aR7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.535.0/LICENSE
```

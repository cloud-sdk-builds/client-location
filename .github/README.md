...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BulqjM6+mcz5DRqJT6sfJtdEN2Wl6lIBSsbP3UO0qOb28kuPTowtjWt9A3Zidn/M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.967.0/index.min.mjs": "sha384-BulqjM6+mcz5DRqJT6sfJtdEN2Wl6lIBSsbP3UO0qOb28kuPTowtjWt9A3Zidn/M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.967.0/LICENSE
```

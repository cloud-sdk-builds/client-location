...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.208.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.208.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NTkETOPY96hY43wFi8/SE2QrGbZqnDtFcZlqw2DIrbiMqx/BCrKXkhup37xikzo1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.208.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.208.0/index.min.mjs": "sha384-NTkETOPY96hY43wFi8/SE2QrGbZqnDtFcZlqw2DIrbiMqx/BCrKXkhup37xikzo1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.208.0/LICENSE
```

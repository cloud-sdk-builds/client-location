...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.316.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.316.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FsSWJxu4VT1LVfyHan5Q6zdSno0OIyBvNit/DQclt+R3p7lrsIOXqOfs8j6mzlY3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.316.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.316.0/index.min.mjs": "sha384-FsSWJxu4VT1LVfyHan5Q6zdSno0OIyBvNit/DQclt+R3p7lrsIOXqOfs8j6mzlY3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.316.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.810.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.810.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GDpq9B26W0Ax1cgZ+ZDoP2SjdKkRwqRh1tJMnpGrvljbO3jerY/Jb0jqTt5mnEU9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.810.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.810.0/index.min.mjs": "sha384-GDpq9B26W0Ax1cgZ+ZDoP2SjdKkRwqRh1tJMnpGrvljbO3jerY/Jb0jqTt5mnEU9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.810.0/LICENSE
```

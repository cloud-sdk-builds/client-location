...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.229.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.229.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-G9i/5wCGrTE+oS+W94cWmWCNajDg97q2qEIj0ZgjGhW87XiEgBYYLx5c5jUeZCDK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.229.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.229.0/index.min.mjs": "sha384-G9i/5wCGrTE+oS+W94cWmWCNajDg97q2qEIj0ZgjGhW87XiEgBYYLx5c5jUeZCDK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.229.0/LICENSE
```

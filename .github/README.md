...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6kN8e4rj34d/gR546Ur3Lk/fsgVd1GSrWw+c6bUoUjnYQ+4BwkjKDE1XT5a2WuZs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.974.0/index.min.mjs": "sha384-6kN8e4rj34d/gR546Ur3Lk/fsgVd1GSrWw+c6bUoUjnYQ+4BwkjKDE1XT5a2WuZs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.974.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PbGLrKC1P4vM9y13SYnD5zz4Js1s3Q5tH/SkgwlDVKxCba+i24QbTYvXZGvFlL+o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.624.0/index.min.mjs": "sha384-PbGLrKC1P4vM9y13SYnD5zz4Js1s3Q5tH/SkgwlDVKxCba+i24QbTYvXZGvFlL+o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.624.0/LICENSE
```

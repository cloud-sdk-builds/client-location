...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U21r+jwtlJrc5viVf7uBTvzACtmsHq+2i4MSkq0JhVHd7jPNk1WkYXl7zW0akjAH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.575.0/index.min.mjs": "sha384-U21r+jwtlJrc5viVf7uBTvzACtmsHq+2i4MSkq0JhVHd7jPNk1WkYXl7zW0akjAH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.575.0/LICENSE
```

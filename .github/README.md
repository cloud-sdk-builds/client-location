...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MrWJOyy1eRHe7Ouzbw14WQfMpY12JmSVI6QiF05MyMstUJAAx1wfoi9A4SCMfhQG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.958.0/index.min.mjs": "sha384-MrWJOyy1eRHe7Ouzbw14WQfMpY12JmSVI6QiF05MyMstUJAAx1wfoi9A4SCMfhQG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.958.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.888.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.888.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+dPFahRhQD9tUgp2q/zxCdq8ThBp8pn6tekMWKrmCTSF400tLJRlvypOKFTs7t9p
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.888.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.888.0/index.min.mjs": "sha384-+dPFahRhQD9tUgp2q/zxCdq8ThBp8pn6tekMWKrmCTSF400tLJRlvypOKFTs7t9p"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.888.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VBSeruGKkk5JJbE2NRNQAEkXJpnrPWv1/LZMh2X6MwI+u0ocf/pzEzYkM99lXket
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.858.0/index.min.mjs": "sha384-VBSeruGKkk5JJbE2NRNQAEkXJpnrPWv1/LZMh2X6MwI+u0ocf/pzEzYkM99lXket"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.858.0/LICENSE
```

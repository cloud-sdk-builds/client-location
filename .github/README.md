...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.354.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.354.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ko1ZAe9f3IJKfrFRXjwzt4Na5QtYleBMXN6GG0J2MWtWD/aXHcF823szmMqo3gP/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.354.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.354.0/index.min.mjs": "sha384-ko1ZAe9f3IJKfrFRXjwzt4Na5QtYleBMXN6GG0J2MWtWD/aXHcF823szmMqo3gP/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.354.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RN2WamcQLamPKDB5zEz4tbGI3thCI+D+lScBpsbDKqO0152zbUziP95QqCfMnJXU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.201.0/index.min.mjs": "sha384-RN2WamcQLamPKDB5zEz4tbGI3thCI+D+lScBpsbDKqO0152zbUziP95QqCfMnJXU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.201.0/LICENSE
```

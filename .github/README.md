...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/h0YmJHlARwA85but1vVnrBmBRaOiLlxSrOSdpigw5hvYzT36oHCzkZCeWQDauCP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.150.0/index.min.mjs": "sha384-/h0YmJHlARwA85but1vVnrBmBRaOiLlxSrOSdpigw5hvYzT36oHCzkZCeWQDauCP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.150.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tn+HbYLo2j3s60516ITlnrPCczt88QxZV1PSnoIxEdX76H6AOGZekhdBwzjTqexL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.428.0/index.min.mjs": "sha384-tn+HbYLo2j3s60516ITlnrPCczt88QxZV1PSnoIxEdX76H6AOGZekhdBwzjTqexL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.428.0/LICENSE
```

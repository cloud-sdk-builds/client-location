...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j78RiNd8WWCJ/a0U/ntoiCqL7ajdcH9COvJyr3KQSwSJTpXJN8prljBPAhCUod0i
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.882.0/index.min.mjs": "sha384-j78RiNd8WWCJ/a0U/ntoiCqL7ajdcH9COvJyr3KQSwSJTpXJN8prljBPAhCUod0i"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.882.0/LICENSE
```

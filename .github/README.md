...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.969.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wyN6lUTaHZTavsaN9ekogm70x0a3Tf2b9zObCkntluTTF72kC1e6AcUUrexaQfaS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.969.0/index.min.mjs": "sha384-wyN6lUTaHZTavsaN9ekogm70x0a3Tf2b9zObCkntluTTF72kC1e6AcUUrexaQfaS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.969.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qHwTV13/beHX/COvh6zdQke2CamYvnLszUq4DgaMW3D70og83Vuqfs43uFZoN48I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.901.0/index.min.mjs": "sha384-qHwTV13/beHX/COvh6zdQke2CamYvnLszUq4DgaMW3D70og83Vuqfs43uFZoN48I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.901.0/LICENSE
```

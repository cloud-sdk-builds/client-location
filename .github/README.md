...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.665.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.665.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oTwxTSZjWsR3Dtmpy1v3iQ/n25WadbiTX+ejEjZq172qKJoiuJXOmapnst3+8Mkt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.665.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.665.0/index.min.mjs": "sha384-oTwxTSZjWsR3Dtmpy1v3iQ/n25WadbiTX+ejEjZq172qKJoiuJXOmapnst3+8Mkt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.665.0/LICENSE
```

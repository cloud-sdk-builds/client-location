...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.261.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.261.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ojfKaZEVnNexIFGuKFxN3eNOrQqR1f5Z8oAVW3FKj/l+UX4ECoqJHfJZl74Y4WGH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.261.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.261.0/index.min.mjs": "sha384-ojfKaZEVnNexIFGuKFxN3eNOrQqR1f5Z8oAVW3FKj/l+UX4ECoqJHfJZl74Y4WGH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.261.0/LICENSE
```

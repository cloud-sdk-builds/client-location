...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-pbhP3n03q6K1vq+S5IyCsa50sTYQm5GPwaGxF/F52dsJ9TM9naoYclBLRS7l6yry
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.726.1/index.min.mjs": "sha384-pbhP3n03q6K1vq+S5IyCsa50sTYQm5GPwaGxF/F52dsJ9TM9naoYclBLRS7l6yry"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.726.1/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-58jl9MmdJ265RKoNCAOi4rS7owUQdNqinj0gGec4uimSdRwcVxI/akI1OzkfR8jb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.81.0/index.min.mjs": "sha384-58jl9MmdJ265RKoNCAOi4rS7owUQdNqinj0gGec4uimSdRwcVxI/akI1OzkfR8jb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.81.0/LICENSE
```

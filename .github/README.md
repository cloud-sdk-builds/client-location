...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.382.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.382.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NnoGo26Y1w2XEblaMfJ0h5q/c7+HS/PHcDDLjY9XmU89QTVHsfocVMJNjGDnzoxS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.382.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.382.0/index.min.mjs": "sha384-NnoGo26Y1w2XEblaMfJ0h5q/c7+HS/PHcDDLjY9XmU89QTVHsfocVMJNjGDnzoxS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.382.0/LICENSE
```

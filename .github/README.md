...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zGS0tbp1N+Led/qZCuLqChHi/qSoOfHbWRk7wVy5dKKiFWTS2q08Pce02qB2Zelp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.458.0/index.min.mjs": "sha384-zGS0tbp1N+Led/qZCuLqChHi/qSoOfHbWRk7wVy5dKKiFWTS2q08Pce02qB2Zelp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.458.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.651.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.651.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-VDUDYQWLYC1P8pSFALfMmID4r+TUaQIYO4nvL0nwFyzSKsKm/hSCeZCkPgX5BNZk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.651.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.651.1/index.min.mjs": "sha384-VDUDYQWLYC1P8pSFALfMmID4r+TUaQIYO4nvL0nwFyzSKsKm/hSCeZCkPgX5BNZk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.651.1/LICENSE
```

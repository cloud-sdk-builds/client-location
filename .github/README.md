...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ky3k/4UPqYJMBMPW2VHkpEBqKHEkn3Sd3PUruAn5C9VLw9KTX4PSbVmAvIrR64m5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.983.0/index.min.mjs": "sha384-ky3k/4UPqYJMBMPW2VHkpEBqKHEkn3Sd3PUruAn5C9VLw9KTX4PSbVmAvIrR64m5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.983.0/LICENSE
```

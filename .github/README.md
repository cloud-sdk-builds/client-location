...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.319.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.319.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ImlBGr5mSzEMNurAp876YP3f1gMr3wfKSOPTY+duqLbqoV4GVqCaBauPvwowhvR4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.319.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.319.0/index.min.mjs": "sha384-ImlBGr5mSzEMNurAp876YP3f1gMr3wfKSOPTY+duqLbqoV4GVqCaBauPvwowhvR4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.319.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.86.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.86.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A50hPRzOQDsrc8Jgb6GLl9zRPEL57XP2YnhHUA/QKT6utt1L3FAprypWnmtGIIwS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.86.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.86.0/index.min.mjs": "sha384-A50hPRzOQDsrc8Jgb6GLl9zRPEL57XP2YnhHUA/QKT6utt1L3FAprypWnmtGIIwS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.86.0/LICENSE
```

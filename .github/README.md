...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q4PJa6hk2pX2WLMheU+hD0mOunb4dWiaElaQvn6mDTwUI8FiG/75/1dKMB93hpYn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.679.0/index.min.mjs": "sha384-Q4PJa6hk2pX2WLMheU+hD0mOunb4dWiaElaQvn6mDTwUI8FiG/75/1dKMB93hpYn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.679.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-txGIroPUv8ZLBT9JwTrw+sJfBEwNRLA0X8eBkiipB1yFK6981/4diLR2psof7yzX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.992.0/index.min.mjs": "sha384-txGIroPUv8ZLBT9JwTrw+sJfBEwNRLA0X8eBkiipB1yFK6981/4diLR2psof7yzX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.992.0/LICENSE
```

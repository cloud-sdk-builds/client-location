...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ColouTtFfn5NwTZHmiDZPtt7Wi8EVKuwmPnLI1eGGul6HR/7KckdKUnkFXDxs+5O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.47.0/index.min.mjs": "sha384-ColouTtFfn5NwTZHmiDZPtt7Wi8EVKuwmPnLI1eGGul6HR/7KckdKUnkFXDxs+5O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.47.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X+VLRnAJUsM/+6J+kPuYuGEAJl141eKRRcGvn7qo5DvBGEwF6dS5M9yiWXbQvjVq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.893.0/index.min.mjs": "sha384-X+VLRnAJUsM/+6J+kPuYuGEAJl141eKRRcGvn7qo5DvBGEwF6dS5M9yiWXbQvjVq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.893.0/LICENSE
```

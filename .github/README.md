...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.231.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.231.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vGnpjDzGmKjYOWTf/+B56wjjciN5C+9xfa2yUrK2BC5+KltObnuNdBvjni5QUljp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.231.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.231.0/index.min.mjs": "sha384-vGnpjDzGmKjYOWTf/+B56wjjciN5C+9xfa2yUrK2BC5+KltObnuNdBvjni5QUljp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.231.0/LICENSE
```

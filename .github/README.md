...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vLqOVlDTku2rhXM11N1S/JbftFpe9rJboISASpbuTqfOrv8f5ftEwqfKLz5O3J7h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.212.0/index.min.mjs": "sha384-vLqOVlDTku2rhXM11N1S/JbftFpe9rJboISASpbuTqfOrv8f5ftEwqfKLz5O3J7h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.212.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.196.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.196.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fPmUs+vwEgawagmgWE8WGrVF/B4js8sAaWl0AKE8pCR7v0JO5M/JaTtK8iMlfgtI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.196.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.196.0/index.min.mjs": "sha384-fPmUs+vwEgawagmgWE8WGrVF/B4js8sAaWl0AKE8pCR7v0JO5M/JaTtK8iMlfgtI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.196.0/LICENSE
```

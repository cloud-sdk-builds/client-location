...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.574.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.574.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KD/zexaIuwKxEnpXMczl7va7CIBtkqAOUE2gbZmStYWsg1MtjiNx1lILOwIQ/xEM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.574.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.574.0/index.min.mjs": "sha384-KD/zexaIuwKxEnpXMczl7va7CIBtkqAOUE2gbZmStYWsg1MtjiNx1lILOwIQ/xEM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.574.0/LICENSE
```

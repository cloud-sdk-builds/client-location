...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-8Jcslv0Nm71d+P4Rq3gVMSJXu7Wc+T/W2thSqJ/yhNjcvp3489ohbw02nM11hF94
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.658.1/index.min.mjs": "sha384-8Jcslv0Nm71d+P4Rq3gVMSJXu7Wc+T/W2thSqJ/yhNjcvp3489ohbw02nM11hF94"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.658.1/LICENSE
```

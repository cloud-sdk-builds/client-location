...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vQTfMBlQez2vIvT7IBjUXxhgIsSz3mEYEH3Q/mvlP1mlQWvZGeSdv4sNKeZW/uqX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.787.0/index.min.mjs": "sha384-vQTfMBlQez2vIvT7IBjUXxhgIsSz3mEYEH3Q/mvlP1mlQWvZGeSdv4sNKeZW/uqX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.787.0/LICENSE
```

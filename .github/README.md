...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.450.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.450.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Uy68y3vttBWg4ANawjTOjrRy6kO0IgWZfPrOlNxWgF3aGRFgnN/f6u54NAdK68uz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.450.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.450.0/index.min.mjs": "sha384-Uy68y3vttBWg4ANawjTOjrRy6kO0IgWZfPrOlNxWgF3aGRFgnN/f6u54NAdK68uz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.450.0/LICENSE
```

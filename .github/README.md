...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sdv40OglC1AUT5fjHMtVzOIlzbPbNgTsgBt/Pmp3RQDJ1MH2NHOd2TTHS5v/MG89
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.775.0/index.min.mjs": "sha384-sdv40OglC1AUT5fjHMtVzOIlzbPbNgTsgBt/Pmp3RQDJ1MH2NHOd2TTHS5v/MG89"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.775.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cGtiWdabvpLwfwaXyCTEkyQDFSUwaBUE02oSlBBrx6AdM2XUQ1NvtL7lyEnAKTnJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.796.0/index.min.mjs": "sha384-cGtiWdabvpLwfwaXyCTEkyQDFSUwaBUE02oSlBBrx6AdM2XUQ1NvtL7lyEnAKTnJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.796.0/LICENSE
```

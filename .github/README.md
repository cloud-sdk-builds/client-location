...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.341.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.341.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WDhyMyvX8U4z9iO8JsC05D6UzgVQumgRBKmymES/hKp50Ytn93Bvfkqpc2yiFHDP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.341.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.341.0/index.min.mjs": "sha384-WDhyMyvX8U4z9iO8JsC05D6UzgVQumgRBKmymES/hKp50Ytn93Bvfkqpc2yiFHDP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.341.0/LICENSE
```

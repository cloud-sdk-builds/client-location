...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.930.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.930.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1M45Ig6617xyf9r9rsNuvbd1xr02MAzNiDCbV3sfjVXMpU2Xp4NWWcjIBo3PMlxZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.930.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.930.0/index.min.mjs": "sha384-1M45Ig6617xyf9r9rsNuvbd1xr02MAzNiDCbV3sfjVXMpU2Xp4NWWcjIBo3PMlxZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.930.0/LICENSE
```

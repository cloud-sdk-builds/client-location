...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.105.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pH9S+/8Ovhzeq73sAbyrJsnHEGHh/h2hUwbIekhPj1LDX3iK646hEdxhoCai6VpV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.105.0/index.min.mjs": "sha384-pH9S+/8Ovhzeq73sAbyrJsnHEGHh/h2hUwbIekhPj1LDX3iK646hEdxhoCai6VpV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.105.0/LICENSE
```

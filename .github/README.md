...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-LkKRHaD51oRz6IQUYi021zjzlizkMQyiPAPqa88kr5IhUDNq1tSSG9uRgHcqTltf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.47.1/index.min.mjs": "sha384-LkKRHaD51oRz6IQUYi021zjzlizkMQyiPAPqa88kr5IhUDNq1tSSG9uRgHcqTltf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.47.1/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.14.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.14.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YUFYqF9d8j8rF3/rj3Yg/9bIiYL962i7O+rJogJ2mhQafHLoppa4u/6tgSkAi5e4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.14.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.14.0/index.min.mjs": "sha384-YUFYqF9d8j8rF3/rj3Yg/9bIiYL962i7O+rJogJ2mhQafHLoppa4u/6tgSkAi5e4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.14.0/LICENSE
```

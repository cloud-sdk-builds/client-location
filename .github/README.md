...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.218.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.218.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gRAiohrFcLqHm8tVvC7a4ynG15bb/3TdZbfU1AkDogMysW1E4HLVLsKO/TcTnjUk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.218.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.218.0/index.min.mjs": "sha384-gRAiohrFcLqHm8tVvC7a4ynG15bb/3TdZbfU1AkDogMysW1E4HLVLsKO/TcTnjUk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.218.0/LICENSE
```

...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.213.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.213.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bmbj2LW6rzSSGYGaMhNS/v8hd1iCoxnaXz6vzXJLPS9xFWHiZe7lQqSzutah1OGq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.213.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.213.0/index.min.mjs": "sha384-Bmbj2LW6rzSSGYGaMhNS/v8hd1iCoxnaXz6vzXJLPS9xFWHiZe7lQqSzutah1OGq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.213.0/LICENSE
```

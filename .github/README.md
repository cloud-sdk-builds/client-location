...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.637.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.637.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eh3HXPEfTrrfs95zO7LeM424KE3vh0Iih6Bkr7C84fsNYmCMV9ACYiqXif3DKInB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.637.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.637.0/index.min.mjs": "sha384-eh3HXPEfTrrfs95zO7LeM424KE3vh0Iih6Bkr7C84fsNYmCMV9ACYiqXif3DKInB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.637.0/LICENSE
```

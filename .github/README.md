...
[`@aws-sdk/client-location`](https://www.npmjs.com/package/@aws-sdk/client-location/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KQPmdAfKY8H3777M8g9ShSd5vfX5nLTdwBJRWpzsQRz3+w2u3mGFrBaSbPvsWKgC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-location": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-location@3.864.0/index.min.mjs": "sha384-KQPmdAfKY8H3777M8g9ShSd5vfX5nLTdwBJRWpzsQRz3+w2u3mGFrBaSbPvsWKgC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-location/blob/refs/tags/3.864.0/LICENSE
```
